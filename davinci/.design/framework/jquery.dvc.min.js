...
function(d,k){if(r)s.unshift(arguments);else{var l=b.extend({},b.mobile.changePage.defaults,k);l.pageContainer=l.pageContainer||b.mobile.pageContainer;l.fromPage=l.fromPage||b.mobile.activePage;var m=l.pageContainer,o=new b.Event("pagebeforechange"),q={toPage:d,options:l};m.trigger(o,q);if(!o.isDefaultPrevented())if(d=q.toPage,r=true,typeof d=="string")b.mobile.loadPage(d,l).done(function(a,c,f,d){r=false;c.duplicateCachedPage=d;b.mobile.changePage(f,c)}).fail(function(){r=false;f(true);g();l.pageContainer.trigger("pagechangefailed",
...
function(){b(a).delegate("form","submit",function(a){var c=b(this);if(b.mobile.ajaxEnabled&&!c.is(":jqmData(ajax='false')")&&c.jqmHijackable().length){var f=c.attr("method"),d=c.attr("target"),g=c.attr("action");if(!g&&(g=l(c),g===u.hrefNoHash))g=w.hrefNoSearch;g=n.makeUrlAbsolute(g,l(c));!n.isExternal(g)&&!d&&(b.mobile.changePage(g,{type:f&&f.length&&f.toLowerCase()||"get",data:c.serialize(),transition:c.jqmData("transition"),direction:c.jqmData("direction"),reloadPage:true}),a.preventDefault())}});
...
(function(e){e.widget("davinci.dvcListview",e.davinci.dvcScrollview,{options:{type:"none",eventNames:"ev_click,ev_change,ev_keyup,ev_swipeleft,ev_swiperight,ev_focus,ev_blur".split(","),initSelector:":jqmData(role='dvcListview')"},classes:{CLS_WIDGET:"dvc-listview"},_appendChildElements:function(){var d=this.element,a=this.options;if(d.children().length==0)this._designDefault(d.jqmData("role").slice(3));else{var b=d.children(),c=e("<div data-role='ListItem'>");c.append(b);d.append(c);c.dvcListitem({type:a.type})}},
_create:function(){this._initWidget();this._appendChildElements();this._initVars();this._addDOMAttrModifiedEventListener();this.refresh()},_empty:function(){},getListitem:function(){return this._listItem}})})(jQuery);
