...
(function(e,d,a){typeof define==="function"&&define.amd?define(["jquery"],function(b){a(b,e,d);return b.mobile}):a(e.jQuery,e,d)})(this,document,function(e,d,a){(function(b,a,f,g){function h(b){for(;b&&typeof b.originalEvent!=="undefined";)b=b.originalEvent;return b}function d(a){for(var c={},f,g;a;){f=b.data(a,v);for(g in f)if(f[g])c[g]=c.hasVirtualBinding=true;a=a.parentNode}return c}function e(){z&&(clearTimeout(z),z=0);z=setTimeout(function(){D=z=0;F.length=0;J=false;E=true},b.vmouse.resetTimerDuration)}
function k(a,c,f){var d,j;if(!(j=f&&f[a])){if(f=!f)a:{for(f=c.target;f;){if((j=b.data(f,v))&&(!a||j[a]))break a;f=f.parentNode}f=null}j=f}if(j){d=c;var f=d.type,e,l;d=b.Event(d);d.type=a;j=d.originalEvent;e=b.event.props;f.search(/^(mouse|click)/)>-1&&(e=x);if(j)for(l=e.length;l;)a=e[--l],d[a]=j[a];if(f.search(/mouse(down|up)|click/)>-1&&!d.which)d.which=1;if(f.search(/^touch/)!==-1&&(a=h(j),f=a.touches,a=a.changedTouches,f=f&&f.length?f[0]:a&&a.length?a[0]:g))for(j=0,len=u.length;j<len;j++)a=u[j],
d[a]=f[a];b(c.target).trigger(d)}return d}function m(a){var c=b.data(a.target,w);if(!J&&(!D||D!==c))if(c=k("v"+a.type,a))c.isDefaultPrevented()&&a.preventDefault(),c.isPropagationStopped()&&a.stopPropagation(),c.isImmediatePropagationStopped()&&a.stopImmediatePropagation()}function o(a){var c=h(a).touches,f;if(c&&c.length===1&&(f=a.target,c=d(f),c.hasVirtualBinding))D=M++,b.data(f,w,D),z&&(clearTimeout(z),z=0),C=E=false,f=h(a).touches[0],A=f.pageX,B=f.pageY,k("vmouseover",a,c),k("vmousedown",a,c)}
function n(b){E||(C||k("vmousecancel",b,d(b.target)),C=true,e())}function q(a){if(!E){var c=h(a).touches[0],f=C,g=b.vmouse.moveDistanceThreshold;C=C||Math.abs(c.pageX-A)>g||Math.abs(c.pageY-B)>g;flags=d(a.target);C&&!f&&k("vmousecancel",a,flags);k("vmousemove",a,flags);e()}}function p(b){if(!E){E=true;var a=d(b.target),c;k("vmouseup",b,a);if(!C&&(c=k("vclick",b,a))&&c.isDefaultPrevented())c=h(b).changedTouches[0],F.push({touchID:D,x:c.clientX,y:c.clientY}),J=true;k("vmouseout",b,a);C=false;e()}}function s(a){var a=
...
resetTimerDuration:1500};for(var H=0;H<a.length;H++)b.event.special[a[H]]=t(a[H]);K&&f.addEventListener("click",function(a){var c=F.length,f=a.target,g,h,d,j,e;if(c){g=a.clientX;h=a.clientY;threshold=b.vmouse.clickDistanceThreshold;for(d=f;d;){for(j=0;j<c;j++)if(e=F[j],d===f&&Math.abs(e.x-g)<threshold&&Math.abs(e.y-h)<threshold||b.data(d,w)===e.touchID){a.preventDefault();a.stopPropagation();return}d=d.parentNode}}},true)})(jQuery,d,a);(function(b,c,f){function g(b){b=b||location.href;return"#"+b.replace(/^[^#]*#?(.*)$/,
"$1")}var h="hashchange",d=a,e,k=b.event.special,m=d.documentMode,o="on"+h in c&&(m===f||m>7);b.fn[h]=function(b){return b?this.bind(h,b):this.trigger(h)};b.fn[h].delay=50;k[h]=b.extend(k[h],{setup:function(){if(o)return false;b(e.start)},teardown:function(){if(o)return false;b(e.stop)}});e=function(){function a(){var f=g(),d=v(k);if(f!==k)t(k=f,d),b(c).trigger(h);else if(d!==k)location.href=location.href.replace(/#.*/,"")+d;l=setTimeout(a,b.fn[h].delay)}var e={},l,k=g(),m=function(b){return b},t=
m,v=m;e.start=function(){l||a()};e.stop=function(){l&&clearTimeout(l);l=f};b.browser.msie&&!o&&function(){var c,f;e.start=function(){if(!c)f=(f=b.fn[h].src)&&f+g(),c=b('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){f||t(g());a()}).attr("src",f||"javascript:0").insertAfter("body")[0].contentWindow,d.onpropertychange=function(){try{if(event.propertyName==="title")c.document.title=d.title}catch(b){}}};e.stop=m;v=function(){return g(c.location.href)};t=function(a,f){var g=c.document,
e=b.fn[h].domain;if(a!==f)g.title=d.title,g.open(),e&&g.write('<script>document.domain="'+e+'"<\/script>'),g.close(),c.location.hash=a}}();return e}()})(jQuery,this);(function(b,a){if(b.cleanData){var f=b.cleanData;b.cleanData=function(a){for(var c=0,g;(g=a[c])!=null;c++)b(g).triggerHandler("remove");f(a)}}else{var g=b.fn.remove;b.fn.remove=function(a,c){return this.each(function(){c||(!a||b.filter(a,[this]).length)&&b("*",this).add([this]).each(function(){b(this).triggerHandler("remove")});return g.call(b(this),
...
function e(a,c){c&&a.attr("data-"+b.mobile.ns+"role",c);a.page()}function l(b){for(;b;){if(typeof b.nodeName==="string"&&b.nodeName.toLowerCase()=="a")break;b=b.parentNode}return b}function k(a){var a=b(a).closest(".ui-page").jqmData("url"),c=u.hrefNoHash;if(!a||!n.isPath(a))a=c;return n.makeUrlAbsolute(a,c)}var m=b(d);b("html");var o=b("head"),n={urlParseRE:/^(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,
...
b(this).attr(a,v+c)})}h.attr("data-"+b.mobile.ns+"url",n.convertUrlToDataUrl(o)).attr("data-"+b.mobile.ns+"external-page",true).appendTo(d.pageContainer);h.one("pagecreate",b.mobile._bindPageRemove);e(h,d.role);m.indexOf("&"+b.mobile.subPageUrlKey)>-1&&(h=d.pageContainer.children(":jqmData(url='"+q+"')"));d.showLoadMsg&&(clearTimeout(t),b.mobile.hidePageLoadingMsg());r.xhr=p;r.textStatus=k;r.page=h;d.pageContainer.trigger("pageload",r);g.resolve(m,f,h,l)},error:function(a,c,h){y&&y.set(n.get());r.xhr=
...
function(d,l){if(r)s.unshift(arguments);else{var k=b.extend({},b.mobile.changePage.defaults,l);k.pageContainer=k.pageContainer||b.mobile.pageContainer;k.fromPage=k.fromPage||b.mobile.activePage;var m=k.pageContainer,o=new b.Event("pagebeforechange"),q={toPage:d,options:k};m.trigger(o,q);if(!o.isDefaultPrevented())if(d=q.toPage,r=true,typeof d=="string")b.mobile.loadPage(d,k).done(function(a,c,f,g){r=false;c.duplicateCachedPage=g;b.mobile.changePage(f,c)}).fail(function(){r=false;f(true);g();k.pageContainer.trigger("pagechangefailed",
q)});else{if(d[0]===b.mobile.firstPage[0]&&!k.dataUrl)k.dataUrl=w.hrefNoHash;var o=k.fromPage,u=k.dataUrl&&n.convertUrlToDataUrl(k.dataUrl)||d.jqmData("url"),y=u;n.getFilePath(u);var v=p.getActive(),z=p.activeIndex===0,x=0,A=a.title,B=k.role==="dialog"||d.jqmData("role")==="dialog";if(o&&o[0]===d[0]&&!k.allowSamePageTransition)r=false,m.trigger("pagechange",q);else{e(d,k.role);k.fromHashChange&&p.directHashChange({currentUrl:u,isBack:function(){x=-1},isForward:function(){x=1}});try{a.activeElement&&
a.activeElement.nodeName.toLowerCase()!="body"?b(a.activeElement).blur():b("input:focus, textarea:focus, select:focus").blur()}catch(N){}B&&v&&(u=(v.url||"")+t);if(k.changeHash!==false&&u)p.ignoreNextHashChange=true,n.set(u);var L=!v?A:d.jqmData("title")||d.children(":jqmData(role='header')").find(".ui-title").getEncodedText();L&&A==a.title&&(A=L);d.jqmData("title")||d.jqmData("title",A);k.transition=k.transition||(x&&!z?v.transition:c)||(B?b.mobile.defaultDialogTransition:b.mobile.defaultPageTransition);
x||p.addNew(u,k.transition,A,y,k.role);a.title=p.getActive().title;b.mobile.activePage=d;k.reverse=k.reverse||x<0;h(d,o,k.transition,k.reverse).done(function(a,c,h,e,j){f();k.duplicateCachedPage&&k.duplicateCachedPage.remove();j||b.mobile.focusPage(d);g();m.trigger("pagechange",q)})}}}};b.mobile.changePage.defaults={transition:c,reverse:false,changeHash:true,fromHashChange:false,role:c,duplicateCachedPage:c,pageContainer:c,showLoadMsg:true,dataUrl:c,fromPage:c,allowSamePageTransition:false};b.mobile._registerInternalEvents=
function(){b(a).delegate("form","submit",function(a){var c=b(this);if(b.mobile.ajaxEnabled&&!c.is(":jqmData(ajax='false')")&&c.jqmHijackable().length){var f=c.attr("method"),g=c.attr("target"),d=c.attr("action");if(!d&&(d=k(c),d===u.hrefNoHash))d=w.hrefNoSearch;d=n.makeUrlAbsolute(d,k(c));!n.isExternal(d)&&!g&&(b.mobile.changePage(d,{type:f&&f.length&&f.toLowerCase()||"get",data:c.serialize(),transition:c.jqmData("transition"),direction:c.jqmData("direction"),reloadPage:true}),a.preventDefault())}});
b(a).bind("vclick",function(a){if(!(a.which>1)&&b.mobile.linkBindingEnabled&&(a=l(a.target),b(a).jqmHijackable().length&&a&&n.parseUrl(a.getAttribute("href")||"#").hash!=="#"))f(true),q=b(a).closest(".ui-btn").not(".ui-disabled"),q.addClass(b.mobile.activeBtnClass),b("."+b.mobile.activePageClass+" .ui-btn").not(a).blur(),b(a).jqmData("href",b(a).attr("href")).attr("href","#")});b(a).bind("click",function(a){if(b.mobile.linkBindingEnabled){var g=l(a.target),h=b(g),e;if(g&&!(a.which>1)&&h.jqmHijackable().length){e=
function(){d.setTimeout(function(){f(true)},200)};h.jqmData("href")&&h.attr("href",h.jqmData("href"));if(h.is(":jqmData(rel='back')"))return d.history.back(),false;var j=k(h),g=n.makeUrlAbsolute(h.attr("href")||"#",j);if(!b.mobile.ajaxEnabled&&!n.isEmbeddedPage(g))e();else{if(g.search("#")!=-1)if(g=g.replace(/[^#]*#/,""))g=n.isPath(g)?n.makeUrlAbsolute(g,j):n.makeUrlAbsolute("#"+g,w.hrefNoHash);else{a.preventDefault();return}var j=h.is("[rel='external']")||h.is(":jqmData(ajax='false')")||h.is("[target]"),
...
(function(b){b.fn.grid=function(a){return this.each(function(){var f=b(this),g=b.extend({grid:null},a),d=f.children(),e={solo:1,a:2,b:3,c:4,d:5},g=g.grid;if(!g)if(d.length<=5)for(var l in e)e[l]===d.length&&(g=l);else g="a";e=e[g];f.addClass("ui-grid-"+g);d.filter(":nth-child("+e+"n+1)").addClass("ui-block-a");e>1&&d.filter(":nth-child("+e+"n+2)").addClass("ui-block-b");e>2&&d.filter(":nth-child(3n+3)").addClass("ui-block-c");e>3&&d.filter(":nth-child(4n+4)").addClass("ui-block-d");e>4&&d.filter(":nth-child(5n+5)").addClass("ui-block-e")})}})(jQuery);
(function(b){b(a).bind("pagecreate create",function(a){b(":jqmData(role='nojs')",a.target).addClass("ui-nojs")})})(jQuery);(function(b,c){function f(b){for(var a;b;){if((a=typeof b.className==="string"&&b.className+" ")&&a.indexOf("ui-btn ")>-1&&a.indexOf("ui-disabled ")<0)break;b=b.parentNode}return b}b.fn.buttonMarkup=function(f){for(var f=f&&b.type(f)=="object"?f:{},d=0;d<this.length;d++){var e=this.eq(d),k=e[0],m=b.extend({},b.fn.buttonMarkup.defaults,{icon:f.icon!==c?f.icon:e.jqmData("icon"),
iconpos:f.iconpos!==c?f.iconpos:e.jqmData("iconpos"),theme:f.theme!==c?f.theme:e.jqmData("theme")||b.mobile.getInheritedTheme(e,"c"),inline:f.inline!==c?f.inline:e.jqmData("inline"),shadow:f.shadow!==c?f.shadow:e.jqmData("shadow"),corners:f.corners!==c?f.corners:e.jqmData("corners"),iconshadow:f.iconshadow!==c?f.iconshadow:e.jqmData("iconshadow"),mini:f.mini!==c?f.mini:e.jqmData("mini")},f),o="ui-btn-inner",n,q,p,s,r,t;b.each(m,function(a,c){k.setAttribute("data-"+b.mobile.ns+a,c);e.jqmData(a,c)});
(t=b.data(k.tagName==="INPUT"||k.tagName==="BUTTON"?k.parentNode:k,"buttonElements"))?(k=t.outer,e=b(k),p=t.inner,s=t.text,b(t.icon).remove(),t.icon=null):(p=a.createElement(m.wrapperEls),s=a.createElement(m.wrapperEls));r=m.icon?a.createElement("span"):null;g&&!t&&g();if(!m.theme)m.theme=b.mobile.getInheritedTheme(e,"c");n="ui-btn ui-btn-up-"+m.theme;n+=m.inline?" ui-btn-inline":"";n+=m.shadow?" ui-shadow":"";n+=m.corners?" ui-btn-corner-all":"";m.mini!==c&&(n+=m.mini?" ui-mini":" ui-fullsize");
m.inline!==c&&(n+=m.inline===false?" ui-btn-block":" ui-btn-inline");if(m.icon)m.icon="ui-icon-"+m.icon,m.iconpos=m.iconpos||"left",q="ui-icon "+m.icon,m.iconshadow&&(q+=" ui-icon-shadow");m.iconpos&&(n+=" ui-btn-icon-"+m.iconpos,m.iconpos=="notext"&&!e.attr("title")&&e.attr("title",e.getEncodedText()));o+=m.corners?" ui-btn-corner-all":"";m.iconpos&&m.iconpos==="notext"&&!e.attr("title")&&e.attr("title",e.getEncodedText());t&&e.removeClass(t.bcls||"");e.removeClass("ui-link").addClass(n);p.className=
o;s.className="ui-btn-text";t||p.appendChild(s);if(r&&(r.className=q,!t||!t.icon))r.appendChild(a.createTextNode("\u00a0")),p.appendChild(r);for(;k.firstChild&&!t;)s.appendChild(k.firstChild);t||k.appendChild(p);t={bcls:n,outer:k,inner:p,text:s,icon:r};b.data(k,"buttonElements",t);b.data(p,"buttonElements",t);b.data(s,"buttonElements",t);r&&b.data(r,"buttonElements",t)}return this};b.fn.buttonMarkup.defaults={corners:true,shadow:true,iconshadow:true,wrapperEls:"span"};var g=function(){var c=b.mobile.buttonMarkup.hoverDelay,
...
null;b(a).delegate(":jqmData(role='page'), :jqmData(role='dialog')","pagecreate",function(){var a=b(this),f=a.data("page").options,g=a.jqmData("role"),d=f.theme;b(":jqmData(role='header'), :jqmData(role='footer'), :jqmData(role='content')",this).jqmEnhanceable().each(function(){var e=b(this),l=e.jqmData("role"),k=e.jqmData("theme"),m=k||f.contentTheme||g==="dialog"&&d,o;e.addClass("ui-"+l);if(l==="header"||l==="footer"){var n=k||(l==="header"?f.headerTheme:f.footerTheme)||d;e.addClass("ui-bar-"+n).attr("role",
l==="header"?"banner":"contentinfo");l==="header"&&(k=e.children("a"),o=k.hasClass("ui-btn-left"),m=k.hasClass("ui-btn-right"),o=o||k.eq(0).not(".ui-btn-right").addClass("ui-btn-left").length,m||k.eq(1).addClass("ui-btn-right"));f.addBackBtn&&l==="header"&&b(".ui-page").length>1&&a.jqmData("url")!==b.mobile.path.stripHash(location.hash)&&!o&&b("<a href='#' class='ui-btn-left' data-"+b.mobile.ns+"rel='back' data-"+b.mobile.ns+"icon='arrow-l'>"+f.backBtnText+"</a>").attr("data-"+b.mobile.ns+"theme",
f.backBtnTheme||n).prependTo(e);e.children("h1, h2, h3, h4, h5, h6").addClass("ui-title").attr({role:"heading","aria-level":"1"})}else l==="content"&&(m&&e.addClass("ui-body-"+m),e.attr("role","main"))})})})(jQuery);(function(b){b.widget("mobile.collapsible",b.mobile.widget,{options:{expandCueText:" click to expand contents",collapseCueText:" click to collapse contents",collapsed:true,heading:"h1,h2,h3,h4,h5,h6,legend",theme:null,contentTheme:null,iconTheme:"d",mini:false,initSelector:":jqmData(role='collapsible')"},
_create:function(){var a=this.element,f=this.options,g=a.addClass("ui-collapsible"),d=a.children(f.heading).first(),e=g.wrapInner("<div class='ui-collapsible-content'></div>").find(".ui-collapsible-content"),l=a.closest(":jqmData(role='collapsible-set')").addClass("ui-collapsible-set");d.is("legend")&&(d=b("<div role='heading'>"+d.html()+"</div>").insertBefore(d),d.next().remove());if(l.length){if(!f.theme)f.theme=l.jqmData("theme")||b.mobile.getInheritedTheme(l,"c");if(!f.contentTheme)f.contentTheme=
l.jqmData("content-theme");if(!f.iconPos)f.iconPos=l.jqmData("iconpos");if(!f.mini)f.mini=l.jqmData("mini")}e.addClass(f.contentTheme?"ui-body-"+f.contentTheme:"");d.insertBefore(e).addClass("ui-collapsible-heading").append("<span class='ui-collapsible-heading-status'></span>").wrapInner("<a href='#' class='ui-collapsible-heading-toggle'></a>").find("a").first().buttonMarkup({shadow:false,corners:false,iconpos:a.jqmData("iconpos")||f.iconPos||"left",icon:"plus",mini:f.mini,theme:f.theme}).add(".ui-btn-inner",
...
c=c.last().addClass("ui-corner-bottom"),c.add(c.find(".ui-btn-inner")).find(".ui-li-link-alt").addClass("ui-corner-br").end().find(".ui-li-thumb").not(".ui-li-icon").addClass("ui-corner-bl"));b||this.element.trigger("updatelayout")},_findFirstElementByTagName:function(b,a,c,d){var e={};for(e[c]=e[d]=true;b;){if(e[b.nodeName])return b;b=b[a]}return null},_getChildrenByTagName:function(a,c,d){var e=[],l={};l[c]=l[d]=true;for(a=a.firstChild;a;)l[a.nodeName]&&e.push(a),a=a.nextSibling;return b(e)},_addThumbClasses:function(a){var c,
d,e=a.length;for(c=0;c<e;c++)d=b(this._findFirstElementByTagName(a[c].firstChild,"nextSibling","img","IMG")),d.length&&(d.addClass("ui-li-thumb"),b(this._findFirstElementByTagName(d[0].parentNode,"parentNode","li","LI")).addClass(d.is(".ui-li-icon")?"ui-li-has-icon":"ui-li-has-thumb"))},refresh:function(c){this.parentPage=this.element.closest(".ui-page");this._createSubPages();var d=this.options,e=this.element,j=e.jqmData("dividertheme")||d.dividerTheme,l=e.jqmData("splittheme"),k=e.jqmData("spliticon"),
...
false:v||"arrow-r",theme:s}),v!=false&&r.length==1&&q.addClass("ui-li-has-arrow"),r.first().removeClass("ui-link").addClass("ui-link-inherit"),r.length>1&&(p+=" ui-li-has-alt",r=r.last(),t=l||r.jqmData("theme")||d.splitTheme,w=r.jqmData("icon"),r.appendTo(q).attr("title",r.getEncodedText()).addClass("ui-li-link-alt").empty().buttonMarkup({shadow:false,corners:false,theme:s,icon:false,iconpos:false}).find(".ui-btn-inner").append(b(a.createElement("span")).buttonMarkup({shadow:true,corners:true,theme:t,
iconpos:"notext",icon:w||v||k||d.splitIcon})))):q.jqmData("role")==="list-divider"?(p+=" ui-li-divider ui-bar-"+j,q.attr("role","heading"),o&&(o=1)):p+=" ui-li-static ui-body-"+s;o&&p.indexOf("ui-li-divider")<0&&(s=q.is(".ui-li-static:first")?q:q.find(".ui-link-inherit"),s.addClass("ui-li-jsnumbering").prepend("<span class='ui-li-dec'>"+o++ +". </span>"));n[p]||(n[p]=[]);n[p].push(q[0])}for(p in n)b(n[p]).addClass(p).children(".ui-btn-inner").addClass(p);e.find("h1, h2, h3, h4, h5, h6").addClass("ui-li-heading").end().find("p, dl").addClass("ui-li-desc").end().find(".ui-li-aside").each(function(){var a=
...
l=a.attr("id"),k=this.options,m="data-"+b.mobile.ns,o=this,n=d.find(":jqmData(role='footer')").jqmData("id"),q;typeof c[j]==="undefined"&&(c[j]=-1);l=l||++c[j];b(a.find("li>ul, li>ol").toArray().reverse()).each(function(c){var d=b(this),g=d.attr("id")||l+"-"+c,c=d.parent(),j=b(d.prevAll().toArray().reverse()),j=j.length?j:b("<span>"+b.trim(c.contents()[0].nodeValue)+"</span>"),o=j.first().getEncodedText(),g=(e||"")+"&"+b.mobile.subPageUrlKey+"="+g,w=d.jqmData("theme")||k.theme,u=d.jqmData("counttheme")||
a.jqmData("counttheme")||k.countTheme;q=true;d.detach().wrap("<div "+m+"role='page' "+m+"url='"+g+"' "+m+"theme='"+w+"' "+m+"count-theme='"+u+"'><div "+m+"role='content'></div></div>").parent().before("<div "+m+"role='header' "+m+"theme='"+k.headerTheme+"'><div class='ui-title'>"+o+"</div></div>").after(n?b("<div "+m+"role='footer' "+m+"id='"+n+"'>"):"").parent().appendTo(b.mobile.pageContainer).page();d=c.find("a:first");d.length||(d=b("<a/>").html(j||o).prependTo(c.empty()));d.attr("href","#"+g)}).listview();
...
(function(b,c){b.widget("mobile.checkboxradio",b.mobile.widget,{options:{theme:null,initSelector:"input[type='checkbox'],input[type='radio']"},_create:function(){var f=this,d=this.element,e=b(d).closest("label"),j=e.length?e:b(d).closest("form,fieldset,:jqmData(role='page'),:jqmData(role='dialog')").find("label").filter("[for='"+d[0].id+"']"),l=d[0].type,e=d.jqmData("mini")||d.closest("form,fieldset").jqmData("mini"),k=l+"-on",m=l+"-off",o=d.parents(":jqmData(type='horizontal')").length?c:m,n=d.jqmData("iconpos")||
d.closest("form,fieldset").jqmData("iconpos");if(!(l!=="checkbox"&&l!=="radio")){b.extend(this,{label:j,inputtype:l,checkedClass:"ui-"+k+(o?"":" "+b.mobile.activeBtnClass),uncheckedClass:"ui-"+m,checkedicon:"ui-icon-"+k,uncheckedicon:"ui-icon-"+m});if(!this.options.theme)this.options.theme=b.mobile.getInheritedTheme(this.element,"c");j.buttonMarkup({theme:this.options.theme,icon:o,shadow:false,mini:e,iconpos:n});e=a.createElement("div");e.className="ui-"+l;d.add(j).wrapAll(e);j.bind({vmouseover:function(a){b(this).parent().is(".ui-disabled")&&
a.stopPropagation()},vclick:function(b){if(d.is(":disabled"))b.preventDefault();else return f._cacheVals(),d.prop("checked",l==="radio"&&true||!d.prop("checked")),d.triggerHandler("click"),f._getInputSet().not(d).prop("checked",false),f._updateAll(),false}});d.bind({vmousedown:function(){f._cacheVals()},vclick:function(){var a=b(this);a.is(":checked")?(a.prop("checked",true),f._getInputSet().not(a).prop("checked",false)):a.prop("checked",false);f._updateAll()},focus:function(){j.addClass(b.mobile.focusClass)},
...
clearSearchButtonText:"clear text"},_create:function(){var c=this.element,f=this.options,g=f.theme||b.mobile.getInheritedTheme(this.element,"c"),e=" ui-body-"+g,j=c.jqmData("mini")==true,l=j?" ui-mini":"",k,m;b("label[for='"+c.attr("id")+"']").addClass("ui-input-text");k=c.addClass("ui-input-text ui-body-"+g);typeof c[0].autocorrect!=="undefined"&&!b.support.touchOverflow&&(c[0].setAttribute("autocorrect","off"),c[0].setAttribute("autocomplete","off"));c.is("[type='search'],:jqmData(type='search')")?
(k=c.wrap("<div class='ui-input-search ui-shadow-inset ui-btn-corner-all ui-btn-shadow ui-icon-searchfield"+e+l+"'></div>").parent(),m=b("<a href='#' class='ui-input-clear' title='"+f.clearSearchButtonText+"'>"+f.clearSearchButtonText+"</a>").bind("click",function(b){c.val("").focus().trigger("change");m.addClass("ui-input-clear-hidden");b.preventDefault()}).appendTo(k).buttonMarkup({icon:"delete",iconpos:"notext",corners:true,shadow:true,mini:j}),g=function(){setTimeout(function(){m.toggleClass("ui-input-clear-hidden",
!c.val())},0)},g(),c.bind("paste cut keyup focus change blur",g)):c.addClass("ui-corner-all ui-shadow-inset"+e+l);c.focus(function(){k.addClass(b.mobile.focusClass)}).blur(function(){k.removeClass(b.mobile.focusClass)}).bind("focus",function(){f.preventFocusZoom&&b.mobile.zoom.disable(true)}).bind("blur",function(){f.preventFocusZoom&&b.mobile.zoom.enable(true)});if(c.is("textarea")){var o=function(){var b=c[0].scrollHeight;c[0].clientHeight<b&&c.height(b+15)},n;c.keyup(function(){clearTimeout(n);
...
role:"search"});b("<input>",{placeholder:f.options.filterPlaceholder}).attr("data-"+b.mobile.ns+"type","search").jqmData("lastval","").bind("keyup change",function(){var d=b(this),g=this.value.toLowerCase(),e=null,e=d.jqmData("lastval")+"",k=false,m="";d.jqmData("lastval",g);e=g.length<e.length||g.indexOf(e)!==0?a.children():a.children(":not(.ui-screen-hidden)");if(g){for(var o=e.length-1;o>=0;o--)d=b(e[o]),m=d.jqmData("filtertext")||d.text(),d.is("li:jqmData(role=list-divider)")?(d.toggleClass("ui-filter-hidequeue",
!k),k=false):f.options.filterCallback(m,g)?d.toggleClass("ui-filter-hidequeue",true):k=true;e.filter(":not(.ui-filter-hidequeue)").toggleClass("ui-screen-hidden",false);e.filter(".ui-filter-hidequeue").toggleClass("ui-screen-hidden",true).toggleClass("ui-filter-hidequeue",false)}else e.toggleClass("ui-screen-hidden",false);f._refreshCorners()}).appendTo(d).textinput();f.options.inset&&d.addClass("ui-listview-filter-inset");d.bind("submit",function(){return false}).insertBefore(a)}})})(jQuery);(function(b,
c){b.widget("mobile.slider",b.mobile.widget,{options:{theme:null,trackTheme:null,disabled:false,initSelector:"input[type='range'], :jqmData(type='range'), :jqmData(role='slider')",mini:false},_create:function(){var f=this,g=this.element,e=b.mobile.getInheritedTheme(g,"c"),j=this.options.theme||e,e=this.options.trackTheme||e,l=g[0].nodeName.toLowerCase(),k=l=="select"?"ui-slider-switch":"",m=g.attr("id"),o=m+"-label",m=b("[for='"+m+"']").attr("id",o),n=function(){return l=="input"?parseFloat(g.val()):
g[0].selectedIndex},q=l=="input"?parseFloat(g.attr("min")):0,p=l=="input"?parseFloat(g.attr("max")):g.find("option").length-1,s=d.parseFloat(g.attr("step")||1),r=this.options.inline||g.jqmData("inline")==true?" ui-slider-inline":"",t=this.options.mini||g.jqmData("mini")?" ui-slider-mini":"",v=a.createElement("a"),w=b(v),u=a.createElement("div"),x=b(u),y=g.jqmData("highlight")&&l!="select"?function(){var c=a.createElement("div");c.className="ui-slider-bg ui-btn-active ui-btn-corner-all";return b(c).prependTo(x)}():
false;v.setAttribute("href","#");u.setAttribute("role","application");u.className=["ui-slider ",k," ui-btn-down-",e," ui-btn-corner-all",r,t].join("");v.className="ui-slider-handle";u.appendChild(v);w.buttonMarkup({corners:true,theme:j,shadow:true}).attr({role:"slider","aria-valuemin":q,"aria-valuemax":p,"aria-valuenow":n(),"aria-valuetext":n(),title:n(),"aria-labelledby":o});b.extend(this,{slider:x,handle:w,valuebg:y,dragging:false,beforeStart:null,userModified:false,mouseMoved:false});if(l=="select"){j=
a.createElement("div");j.className="ui-slider-inneroffset";k=0;for(o=u.childNodes.length;k<o;k++)j.appendChild(u.childNodes[k]);u.appendChild(j);w.addClass("ui-slider-handle-snapping");u=g.find("option");j=0;for(k=u.length;j<k;j++)o=!j?"b":"a",r=!j?" ui-btn-down-"+e:" "+b.mobile.activeBtnClass,a.createElement("div"),t=a.createElement("span"),t.className=["ui-slider-label ui-slider-label-",o,r," ui-btn-corner-all"].join(""),t.setAttribute("role","img"),t.appendChild(a.createTextNode(u[j].innerHTML)),
b(t).prependTo(x);f._labels=b(".ui-slider-label",x)}m.addClass("ui-slider");g.addClass(l==="input"?"ui-slider-input":"ui-slider-switch").change(function(){f.mouseMoved||f.refresh(n(),true)}).keyup(function(){f.refresh(n(),true,true)}).blur(function(){f.refresh(n(),true)});b(a).bind("vmousemove",function(b){if(f.dragging)return f.mouseMoved=true,l==="select"&&w.removeClass("ui-slider-handle-snapping"),f.refresh(b),f.userModified=f.beforeStart!==g[0].selectedIndex,false});x.bind("vmousedown",function(b){f.dragging=
true;f.userModified=false;f.mouseMoved=false;if(l==="select")f.beforeStart=g[0].selectedIndex;f.refresh(b);return false}).bind("vclick",false);x.add(a).bind("vmouseup",function(){if(f.dragging)return f.dragging=false,l==="select"&&(w.addClass("ui-slider-handle-snapping"),f.mouseMoved?f.userModified?f.refresh(f.beforeStart==0?1:0):f.refresh(f.beforeStart):f.refresh(f.beforeStart==0?1:0)),f.mouseMoved=false});x.insertAfter(g);l=="select"&&this.handle.bind({focus:function(){x.addClass(b.mobile.focusClass)},
...
break;case b.mobile.keyCode.END:f.refresh(p);break;case b.mobile.keyCode.PAGE_UP:case b.mobile.keyCode.UP:case b.mobile.keyCode.RIGHT:f.refresh(c+s);break;case b.mobile.keyCode.PAGE_DOWN:case b.mobile.keyCode.DOWN:case b.mobile.keyCode.LEFT:f.refresh(c-s)}}},keyup:function(){if(f._keySliding)f._keySliding=false,b(this).removeClass("ui-state-active")}});this.refresh(c,c,true)},refresh:function(a,c,d){(this.options.disabled||this.element.attr("disabled"))&&this.disable();var e=this.element,l=e[0].nodeName.toLowerCase(),
k=l==="input"?parseFloat(e.attr("min")):0,m=l==="input"?parseFloat(e.attr("max")):e.find("option").length-1,o=l==="input"&&parseFloat(e.attr("step"))>0?parseFloat(e.attr("step")):1;if(typeof a==="object"){if(!this.dragging||a.pageX<this.slider.offset().left-8||a.pageX>this.slider.offset().left+this.slider.width()+8)return;a=Math.round((a.pageX-this.slider.offset().left)/this.slider.width()*100)}else a==null&&(a=l==="input"?parseFloat(e.val()||0):e[0].selectedIndex),a=(parseFloat(a)-k)/(m-k)*100;if(!isNaN(a)){a<
0&&(a=0);a>100&&(a=100);var n=a/100*(m-k)+k,q=(n-k)%o;n-=q;Math.abs(q)*2>=o&&(n+=q>0?o:-o);n=parseFloat(n.toFixed(5));n<k&&(n=k);n>m&&(n=m);this.handle.css("left",a+"%");this.handle.attr({"aria-valuenow":l==="input"?n:e.find("option").eq(n).attr("value"),"aria-valuetext":l==="input"?n:e.find("option").eq(n).getEncodedText(),title:l==="input"?n:e.find("option").eq(n).getEncodedText()});this.valuebg&&this.valuebg.css("width",a+"%");if(this._labels){var k=this.handle.width()/this.slider.width()*100,
p=a&&k+(100-k)*a/100,s=a===100?0:Math.min(k+100-p,100);this._labels.each(function(){var a=b(this).is(".ui-slider-label-a");b(this).width((a?p:s)+"%")})}if(!d)d=false,l==="input"?(d=e.val()!==n,e.val(n)):(d=e[0].selectedIndex!==n,e[0].selectedIndex=n),!c&&d&&e.trigger("change")}},enable:function(){this.element.attr("disabled",false);this.slider.removeClass("ui-disabled").attr("aria-disabled",false);return this._setOption("disabled",false)},disable:function(){this.element.attr("disabled",true);this.slider.addClass("ui-disabled").attr("aria-disabled",
...
function(a){b.mobile.selectmenu.prototype.enhanceWithin(a.target,true)})})(jQuery);(function(b){var c=function(c){var g=c.selectID,e=c.label,j=c.select.closest(".ui-page"),l=b("<div>",{"class":"ui-selectmenu-screen ui-screen-hidden"}).appendTo(j),k=c._selectOptions(),m=c.isMultiple=c.select[0].multiple,o=g+"-button",n=g+"-menu",q=b("<div data-"+b.mobile.ns+"role='dialog' data-"+b.mobile.ns+"theme='"+c.options.theme+"' data-"+b.mobile.ns+"overlay-theme='"+c.options.overlayTheme+"'><div data-"+b.mobile.ns+
"role='header'><div class='ui-title'>"+e.getEncodedText()+"</div></div><div data-"+b.mobile.ns+"role='content'></div></div>"),p=b("<div>",{"class":"ui-selectmenu ui-selectmenu-hidden ui-overlay-shadow ui-corner-all ui-body-"+c.options.overlayTheme+" "+b.mobile.defaultDialogTransition}).insertAfter(l),s=b("<ul>",{"class":"ui-selectmenu-list",id:n,role:"listbox","aria-labelledby":o}).attr("data-"+b.mobile.ns+"theme",c.options.theme).appendTo(p),r=b("<div>",{"class":"ui-header ui-bar-"+c.options.theme}).prependTo(p),
t=b("<h1>",{"class":"ui-title"}).appendTo(r),v;c.isMultiple&&(v=b("<a>",{text:c.options.closeText,href:"#","class":"ui-btn-left"}).attr("data-"+b.mobile.ns+"iconpos","notext").attr("data-"+b.mobile.ns+"icon","delete").appendTo(r).buttonMarkup());b.extend(c,{select:c.select,selectID:g,buttonId:o,menuId:n,thisPage:j,menuPage:q,label:e,screen:l,selectOptions:k,isMultiple:m,theme:c.options.theme,listbox:p,list:s,header:r,headerTitle:t,headerClose:v,menuPageContent:void 0,menuPageClose:void 0,placeholder:"",
...
tapToggle:true,tapToggleBlacklist:"a, input, select, textarea, .ui-header-fixed, .ui-footer-fixed",hideDuringFocus:"input, textarea, select",updatePagePadding:true,trackPersistentToolbars:true,supportBlacklist:function(){var b=navigator.userAgent,a=navigator.platform,g=b.match(/AppleWebKit\/([0-9]+)/),g=!!g&&g[1],e=b.match(/Fennec\/([0-9]+)/),e=!!e&&e[1],j=b.match(/Opera Mobi\/([0-9]+)/),l=!!j&&j[1];return(a.indexOf("iPhone")>-1||a.indexOf("iPad")>-1||a.indexOf("iPod")>-1)&&g&&g<534||d.operamini&&
{}.toString.call(d.operamini)==="[object OperaMini]"||j&&l<7458||b.indexOf("Android")>-1&&g&&g<533||e&&e<6||"palmGetResource"in d&&g&&g<534||b.indexOf("MeeGo")>-1&&b.indexOf("NokiaBrowser/8.5.0")>-1?true:false},initSelector:":jqmData(position='fixed')"},_create:function(){var b=this.options,a=this.element,d=a.is(":jqmData(role='header')")?"header":"footer",e=a.closest(".ui-page");b.supportBlacklist()?this.destroy():(a.addClass("ui-"+d+"-fixed"),b.fullscreen?(a.addClass("ui-"+d+"-fullscreen"),e.addClass("ui-page-"+
...
function(){f.updatePagePadding&&a.updatePagePadding()}).bind("pageshow",function(){a.updatePagePadding();f.updatePagePadding&&b(d).bind("throttledresize."+a.widgetName,function(){a.updatePagePadding()})}).bind("pagebeforehide",function(e,h){f.disablePageZoom&&b.mobile.zoom.enable(true);f.updatePagePadding&&b(d).unbind("throttledresize."+a.widgetName);if(f.trackPersistentToolbars){var j=b(".ui-footer-fixed:jqmData(id)",this),l=b(".ui-header-fixed:jqmData(id)",this),k=j.length&&h.nextPage&&b(".ui-footer-fixed:jqmData(id='"+
j.jqmData("id")+"')",h.nextPage),m=l.length&&h.nextPage&&b(".ui-header-fixed:jqmData(id='"+l.jqmData("id")+"')",h.nextPage),k=k||b();if(k.length||m.length)k.add(m).appendTo(b.mobile.pageContainer),h.nextPage.one("pageshow",function(){k.add(m).appendTo(this)})}})},_visible:true,updatePagePadding:function(){var b=this.element,a=b.is(".ui-header");this.options.fullscreen||b.closest(".ui-page").css("padding-"+(a?"top":"bottom"),b.outerHeight())},_useTransition:function(a){var f=this.element,e=b(d).scrollTop(),
h=f.height(),j=f.closest(".ui-page").height(),l=b.mobile.getScreenHeight(),f=f.is(":jqmData(role='header')")?"header":"footer";return!a&&(this.options.transition&&this.options.transition!=="none"&&(f==="header"&&!this.options.fullscreen&&e>h||f==="footer"&&!this.options.fullscreen&&e+l<j-h)||this.options.fullscreen)},show:function(b){var a=this.element;this._useTransition(b)?a.removeClass("out ui-fixed-hidden").addClass("in"):a.removeClass("ui-fixed-hidden");this._visible=true},hide:function(b){var a=
...
function(a){b(a.target).jqmData("fullscreen")&&b(b.mobile.fixedtoolbar.prototype.options.initSelector,a.target).not(":jqmData(fullscreen)").jqmData("fullscreen",true);b.mobile.fixedtoolbar.prototype.enhanceWithin(a.target)})})(jQuery);(function(b,a){if(/iPhone|iPad|iPod/.test(navigator.platform)&&navigator.userAgent.indexOf("AppleWebKit")>-1){var d=b.mobile.zoom,e,h,j,l,k;b(a).bind("orientationchange.iosorientationfix",d.enable).bind("devicemotion.iosorientationfix",function(b){e=b.originalEvent;
k=e.accelerationIncludingGravity;h=Math.abs(k.x);j=Math.abs(k.y);l=Math.abs(k.z);!a.orientation&&(h>7||(l>6&&j<8||l<8&&j>6)&&h>5)?d.enabled&&d.disable():d.enabled||d.enable()})}})(jQuery,this);(function(b,c){function d(){var a=b("."+b.mobile.activeBtnClass).first();k.css({top:b.support.scrollTop&&l.scrollTop()+l.height()/2||a.length&&a.offset().top||100})}function e(){var a=k.offset(),c=l.scrollTop(),h=b.mobile.getScreenHeight();if(a.top<c||a.top-c>h)k.addClass("ui-loader-fakefix"),d(),l.unbind("scroll",
e).bind("scroll",d)}function h(){j.removeClass("ui-mobile-rendering")}var j=b("html");b("head");var l=b(c);b(c.document).trigger("mobileinit");if(b.mobile.gradeA()){if(b.mobile.ajaxBlacklist)b.mobile.ajaxEnabled=false;j.addClass("ui-mobile ui-mobile-rendering");setTimeout(h,5E3);var k=b("<div class='ui-loader'><span class='ui-icon ui-icon-loading'></span><h1></h1></div>");b.extend(b.mobile,{showPageLoadingMsg:function(a,c,d){j.addClass("ui-loading");if(b.mobile.loadingMessage){var f=d||b.mobile.loadingMessageTextVisible;
a=a||b.mobile.loadingMessageTheme;k.attr("class","ui-loader ui-corner-all ui-body-"+(a||"a")+" ui-loader-"+(f?"verbose":"default")+(d?" ui-loader-textonly":"")).find("h1").text(c||b.mobile.loadingMessage).end().appendTo(b.mobile.pageContainer);e();l.bind("scroll",e)}},hidePageLoadingMsg:function(){j.removeClass("ui-loading");b.mobile.loadingMessage&&k.removeClass("ui-loader-fakefix");b(c).unbind("scroll",d);b(c).unbind("scroll",e)},initializePage:function(){var a=b(":jqmData(role='page'), :jqmData(role='dialog')");
a.length||(a=b("body").wrapInner("<div data-"+b.mobile.ns+"role='page'></div>").children(0));a.each(function(){var a=b(this);a.jqmData("url")||a.attr("data-"+b.mobile.ns+"url",a.attr("id")||location.pathname+location.search)});b.mobile.firstPage=a.first();b.mobile.pageContainer=a.first().parent().addClass("ui-mobile-viewport");l.trigger("pagecontainercreate");b.mobile.showPageLoadingMsg();h();!b.mobile.hashListeningEnabled||!b.mobile.path.stripHash(location.hash)?b.mobile.changePage(b.mobile.firstPage,
{transition:"none",reverse:true,changeHash:false,fromHashChange:true}):l.trigger("hashchange",[true])}});b.mobile._registerInternalEvents();b(function(){c.scrollTo(0,1);b.mobile.defaultHomeScroll=!b.support.scrollTop||b(c).scrollTop()===1?0:1;b.fn.controlgroup&&b(a).bind("pagecreate create",function(a){b(":jqmData(role='controlgroup')",a.target).jqmEnhanceable().controlgroup({excludeInvisible:false})});b.mobile.autoInitializePage&&b.mobile.initializePage();l.load(b.mobile.silentScroll)})}})(jQuery,
...
function(){d.removeContainerBackground()}).bind("pagebeforeshow",function(){d.setContainerBackground()})},removeContainerBackground:function(){e.mobile.pageContainer.removeClass("ui-overlay-"+e.mobile.getInheritedTheme(this.element.parent()))},setContainerBackground:function(d){this.options.theme&&e.mobile.pageContainer.addClass("ui-overlay-"+(d||this.options.theme))},keepNativeSelector:function(){var d=this.options;return d.keepNative&&e.trim(d.keepNative)&&d.keepNative!==d.keepNativeDefault?[d.keepNative,
d.keepNativeDefault].join(", "):d.keepNativeDefault}})})(jQuery);
...
getOSName:function(){return e.davinci.osName},getOSVersion:function(){return e.davinci.osVersion},getDeviceType:function(){return e.davinci.deviceType},showPageLoadingMsg:function(a,b){var c=e.davinci.getActivePage(),c=a?a:c.options.theme;e(".ui-icon-loading").addClass("spin");return e.mobile.showPageLoadingMsg(c,b)},hidePageLoadingMsg:function(){e(".ui-icon-loading").removeClass("spin");return e.mobile.hidePageLoadingMsg()}})})(jQuery);
...
CLS_WIDGET:"",CLS_THEME:null},_init:function(){var a=this.element,b=this.options,c=b.eventNames;c.length&&a._eventRegs(c);b.eventNames=[]},_create:function(){var a=this.element,b=this;b._initWidget();b._appendChildElements();b._attachEvent();b.activate=false;var c=function(){var c=function(){b.activate=true;b._initVars();b.refresh()},d=a.closest(".ui-page");if(d.hasClass(e.mobile.activePageClass)||d.hasClass(e.davinci.dvcPagebox.prototype.classes.CLS_PAGEBOX_ACTIVEPAGE))c();else d.one("ev_pageshow",
function(){c()})};if(b._isElementInDocument(a))c();else a.one("DOMNodeInsertedIntoDocument",function(){setTimeout(function(){c()},100)})},_attachEvent:function(){},_initWidget:function(){},_appendChildElements:function(){},_initVars:function(){},enable:function(a){var b=this.options,c=this.classes;if(a!=d)b.enable=a,a==true?this.element.removeClass(c.CLS_BASE_DISABLED):this.element.addClass(c.CLS_BASE_DISABLED);else return b.enable;return this},visible:function(a){var b=this.options,c=this.classes;
if(a!=d)b.visible=a,a==true?this.element.removeClass(c.CLS_BASE_HIDDEN):this.element.addClass(c.CLS_BASE_HIDDEN);else return b.visible;return this},backgroundLayout:function(a){var b=this.element,c=this.options,d=this.classes;if(arguments.length)switch(b.removeClass(d.CLS_BASE_LAYOUT_TILE+" "+d.CLS_BASE_LAYOUT_STRETCH+" "+d.CLS_BASE_LAYOUT_ZOOM+" "+d.CLS_BASE_LAYOUT_CENTER),c.backgroundLayout=a,a){case "tile":b.addClass(d.CLS_BASE_LAYOUT_TILE);break;case "stretch":b.addClass(d.CLS_BASE_LAYOUT_STRETCH);
break;case "zoom":b.addClass(d.CLS_BASE_LAYOUT_ZOOM);break;case "center":b.addClass(d.CLS_BASE_LAYOUT_CENTER)}else return a=c.backgroundLayout},refresh:function(){this.backgroundLayout(this.backgroundLayout());this.enable(this.enable());this.visible(this.visible())},scrollviewDragged:function(){if(this.scrollview===d&&!this._findScrollview())this.scrollview=0;return this.scrollview&&this.scrollview._didDrag?true:false},_isElementInDocument:function(a){a=this.element;for(a=a[0];a!=document&&a.parentNode;)a=
a.parentNode;return a==document},_getAncestorEnable:function(){var a=this.classes,b=true;this.element.parents(":jqmData(role^='dvc'), .dvc-listitem-item").each(function(){if(e(this).hasClass(a.CLS_BASE_DISABLED))return b=false});return b},_findScrollview:function(){var a=this.element.closest("."+e.davinci.dvcScrollview.prototype.classes.CLS_SCROLLVIEW_CLIP);if(a.length>0){var b=a.jqmData("role");this.scrollview=a.data(b);return true}},_getNativeEvent:function(a){for(;a&&typeof a.originalEvent!=="undefined";)a=
a.originalEvent;return a},getId:function(){var a=this.element,b=a.attr("subid");if(!b)b=a[0].id;return b},_prevmousedown:function(){this._vmouseStatus=1},_prevmouseup:function(a){if(a.type=="vmousecancel")return false;if(this._vmouseStatus!=1)return true;this._vmouseStatus=2;return false},_prevclick:function(){if(this._vmouseStatus!=2)return true;this._vmouseStatus=3;return false}})})(jQuery);
...
c;b=a.css("display");b=="block"?a.css("display","-webkit-box"):(b=="inline"||b=="inline-block")&&a.css("display","-webkit-inline-box");this._initType();this._initIconPos()},_appendChildElements:function(){var a=this.element,b=this.classes;this.$icon=e("<img class='"+b.CLS_BUTTON_ICON+"'>");this.$text=e("<div class='"+b.CLS_BUTTON_TEXT+"' ></div>");a.append(this.$icon);a.append(this.$text)},refresh:function(){var a=this.options;e.davinci.dvcBase.prototype.refresh.call(this);this.textAlign(a.textAlign);
...
"down"){a.checked()==false&&a.checked(true);var e=-1;a.$listitem&&(e=a.$listitem.find(".dvc-listitem-item-indexable").index(a.$item));d.trigger("ev_change",[a,true,e])}f.preventDefault();f.stopPropagation()}},"vmouseup vmousecancel":function(b){!a._prevmouseup(b)&&a.enable()&&a._getAncestorEnable()&&(b.type=="vmousecancel"&&d.addClass(c.CLS_BUTTON_UP).removeClass(c.CLS_BUTTON_DOWN),b.stopPropagation())},vclick:function(f){if(!a._prevclick()&&a.enable()&&a._getAncestorEnable()){if(!a.scrollviewDragged()&&
b.radioEvent!="down"){b.allowDepress==false?a.checked()==false&&a.checked(true):a.toggle();d.addClass(c.CLS_BUTTON_UP).removeClass(c.CLS_BUTTON_DOWN);var e=-1;a.$listitem&&(e=a.$listitem.find(".dvc-listitem-item-indexable").index(a.$item));d.trigger("ev_change",[a,a.checked(),e])}f.stopPropagation()}}})},checked:function(d){var a=this.element,b=this.options;if(arguments.length){var c=b.checked;this._checked(d);if(c==false){var f=null;a.parents().each(function(){if(this.id&&e(this).jqmData("role")!=
...
(function(e){e.widget("davinci.dvcImageRoller",e.davinci.dvcBase,{options:{src:"",frameWidth:0,frameX:0,directionX:"defalt",infiniteX:false,frameHeight:0,frameY:0,directionY:"defalt",infiniteY:false,eventNames:["ev_change"],initSelector:":jqmData(role='dvcImageRoller')"},classes:{CLS_WIDGET:"dvc-imageroller"},_initWidget:function(){var d=this.element,a=this,b=this.options;d.addClass(this.classes.CLS_WIDGET);d.css("background-image","url('"+b.src+"')");this._timerID=0;this._timerCB=function(){a._handleMomentumScroll()};
this._lastMove=0;a._oldX=0;a._oldY=0;a._bgPositionX=0;a._bgPositionY=0},_attachEvent:function(){var d=this.element,a=this;a.dragState=false;d.bind("vmousedown",function(b){if(a.enable()&&a._getAncestorEnable()){if(a._timerID)clearTimeout(a._timerID),a._timerID=0;a._oldX=b.pageX;a._scrollOldX=b.pageX;a._scrollNewX=b.pageX;a._oldY=b.pageY;a._scrollOldY=b.pageY;a._scrollNewY=b.pageY;a._changeframeX(b);a._changeframeY(b);a.dragState=true;return false}});e(document).bind("vmousemove",function(b){if(a.dragState&&
a.enable()&&a._getAncestorEnable())a._lastMove=(new Date).getTime(),a._scrollOldX=a._scrollNewX,a._scrollNewX=b.pageX,a._scrollOldY=a._scrollNewY,a._scrollNewY=b.pageY,a._changeframeX(b),a._changeframeY(b)});d.add(document).bind("vmouseup",function(b){if(a.dragState&&a.enable()&&a._getAncestorEnable()){a.dragState=false;var c=a._checkScrollX(b),b=a._checkScrollY(b);(c||b)&&a._doEasingScroll();return false}})},_changeframeX:function(d){var a=this._oldX,b=d.pageX,c;c=e.davinci.getOSName()==="iOS"?20:
10;if(!(Math.abs(b-a)<c))this._oldX=d.pageX,a>b?this._setFrameX(true):a<b&&this._setFrameX(false)},_changeframeY:function(d){var a=this._oldY,b=d.pageY,c;c=e.davinci.getOSName()==="iOS"?20:10;if(!(Math.abs(b-a)<c))this._oldY=d.pageY,a>b?this._setFrameY(true):a<b&&this._setFrameY(false)},_setFrameX:function(d){var a=this.element,b=this.options,c=this._bgPositionX,f=b.frameX,e=b.frameWidth;b.directionX=="reverse"&&(d=!d);d?c+=e:c-=e;b.infiniteX?c%=f*e:c<0?c=0:c>=f*e&&(c=(f-1)*e);a.css("background-position-x",
-c+"px");this._bgPositionX=c},_setFrameY:function(d){var a=this.element,b=this.options,c=this._bgPositionY,f=b.frameY,e=b.frameHeight;b.directionY=="reverse"&&(d=!d);d?c+=e:c-=e;b.infiniteY?c%=f*e:c<0?c=0:c>=f*e&&(c=(f-1)*e);a.css("background-position-y",-c+"px");this._bgPositionY=c},_checkScrollX:function(){var d=this._scrollOldX-this._scrollNewX;if(!this.options.infiniteX)return false;if(d>0)this._dirX=true;else if(d<0)this._dirX=false;else return false;var a=this._lastMove,b=(new Date).getTime(),
a=a&&b-a<=200;if(!a)return false;this._speedX=a?Math.abs(d):0;return this._speedX<7?false:true},_checkScrollY:function(){var d=this._scrollOldY-this._scrollNewY;if(!this.options.infiniteY)return false;if(d>0)this._dirY=true;else if(d<0)this._dirY=false;else return false;var a=this._lastMove,b=(new Date).getTime(),a=a&&b-a<=200;if(!a)return false;this._speedY=a?Math.abs(d):0;return this._speedY<7?false:true},_doEasingScroll:function(){var d=this.options;if(d.infiniteX&&d.infiniteY)d=Math.max(this._speedX,
this._speedY);else if(d.infiniteX)d=this._speedX;else if(d.infiniteY)d=this._speedY;else return false;if(this._timerID)clearTimeout(this._timerID),this._timerID=0;this._timerInterval=this._getInterval(d);this._timerIntervalInc=1;this._timerID=setTimeout(this._timerCB,this._timerInterval)},_getInterval:function(d){var a=10;return a=e.davinci.getOSName()==="iOS"?d<10?90:d<20?60:d<30?30:10:d<50?150:d<80?100:d<100?80:d<120?50:d<150?20:10},_handleMomentumScroll:function(){var d=this.options;d.infiniteX&&
this._setFrameX(this._dirX);d.infiniteY&&this._setFrameY(this._dirY);this._timerInterval+=this._timerIntervalInc;this._timerInterval<50?this._timerIntervalInc=1:this._timerIntervalInc+=this._timerInterval<100?1:this._timerInterval<140?3:9;this._timerInterval>200?(clearTimeout(this._timerID),this._timerID=0):this._timerID=setTimeout(this._timerCB,this._timerInterval)},refresh:function(){e.davinci.dvcBase.prototype.refresh.call(this);return this}})})(jQuery);
...
this.element,a=this.classes,b=e("<div class='"+a.CLS_PROGRESS_BODY+"'></div>"),a=e("<div class='"+a.CLS_PROGRESS_BAR+"'></div>");b.append(a);this.$progressBody=b;this.$progressBar=a;d.append(b)},_attachEvent:function(){},_getAverage:function(){var d=this.options;return this.$progressBody.width()/(d.max-d.min)},_draw:function(){var d=this.options,a=this._getAverage(),d=parseInt((d.value-d.min)*a),a=this.$progressBar;a[0].style.width=d+"px";d==0?a.hide():a.show()},refresh:function(){var d=this.options;
e.davinci.dvcBase.prototype.refresh.call(this);this.value(d.value);return this},min:function(d){var a=this.options;return arguments.length?(a.min=parseInt(d,10),this.value(a.value),this):a.min},max:function(d){var a=this.options;return arguments.length?(a.max=parseInt(d,10),this.value(a.value),this):a.max},value:function(d){var a=this.options;return arguments.length?(d=Math.max(d,a.min),d=Math.min(d,a.max),a.value=d,this._draw(),this):a.value}})})(jQuery);
...
b;this.$sliderBar=c;this.$sliderHandle=a;b.append(c);d.append(b);d.append(a)},_attachEvent:function(){var d=this.element,a=this,b=a.options,c=this.classes;a.dragState=false;d.bind("vmousedown",function(f){if(a.enable()&&a._getAncestorEnable()){a.$sliderHandle.addClass(c.CLS_SLIDER_HANDLE_DOWN).removeClass(c.CLS_SLIDER_HANDLE_UP);f=a._pageX2Value(f.pageX);a.value(f);if(a.oldValue!=b.value)f=-1,a.$listitem&&(f=a.$listitem.find(".dvc-listitem-item-indexable").index(a.$item)),d.trigger("ev_change",[a,
b.value,f]),a.oldValue=b.value;a.dragState=true;return false}});e(document).bind("vmousemove",function(c){if(a.dragState&&a.enable()&&a._getAncestorEnable()&&(c=a._pageX2Value(c.pageX),a.value(c),a.oldValue!=b.value))c=-1,a.$listitem&&(c=a.$listitem.find(".dvc-listitem-item-indexable").index(a.$item)),d.trigger("ev_change",[a,b.value,c]),a.oldValue=b.value});d.add(document).bind("vmouseup",function(){if(a.dragState&&a.enable()&&a._getAncestorEnable())return a.$sliderHandle.addClass(c.CLS_SLIDER_HANDLE_UP).removeClass(c.CLS_SLIDER_HANDLE_DOWN),
a.dragState=false})},_getAverage:function(){var d=this.options;return this.$sliderBody.width()/(d.max-d.min)},_draw:function(){var d=this.options,a=this.$sliderBar,b=this.$sliderHandle,c=this._getAverage(),d=parseInt((d.value-d.min)*c);b[0].style.left=d+"px";a[0].style.width=d+"px";d==0?a.hide():a.show()},_pageX2Value:function(d){var a=this.element,b=this.options,c=this._getAverage(),f=a.offset().left;d-=f;a=a.width();d<0?d=0:d>a&&(d=a);return Math.round(d/c)+b.min}})})(jQuery);
...
this.element,b=this.options,c=this.classes,d=e("<div class='"+c.CLS_SWITCH_TEXT+"'></div>"),g=e("<div class='"+c.CLS_SWITCH_ON_TEXT+"'>"+b.checkedLabel+"</div>"),b=e("<div class='"+c.CLS_SWITCH_OFF_TEXT+"'>"+b.uncheckedLabel+"</div>");d.append(g);d.append(b);var h=e("<div class='"+c.CLS_SWITCH_HANDLE+"'><div class='"+c.CLS_SWITCH_HANDLE_LEFT+"'></div><div class='"+c.CLS_SWITCH_HANDLE_CENTER+"'></div><div class='"+c.CLS_SWITCH_HANDLE_RIGHT+"'></div></div>"),j=e("<div class='"+c.CLS_SWITCH_ON_IMAGE+
"'></div>"),c=e("<div class='"+c.CLS_SWITCH_OFF_IMAGE+"'></div>");a.append(d);a.append(h);a.append(j);a.append(c);this.$text=d;this.$onText=g;this.$offText=b;this.$handle=h;this.$onImage=j;this.$offImage=c},_attachEvent:function(){var a=this.element,b=this,c=false,f=b.handleWidth/2,g=f+b.maxRange,h,j=false,l=function(a){a<f&&(a=f);a>g&&(a=g);b.currentPos=a-f};a.bind("vmousedown",function(){if(b.enable()&&b._getAncestorEnable())return c=true,false});e(document).bind("vmousemove",function(d){if(c&&
b.enable()&&b._getAncestorEnable()){var f=a.offset().left,d=d.pageX-f;h?j?(l(d),b._draw(b.currentPos)):Math.abs(h-d)>5&&(j=true):h=d;return false}});a.add(document).bind("vmouseup",function(f){if(c&&b.enable()&&b._getAncestorEnable()){var e=a.offset().left;l(f.pageX-e);j==false?b._setChecked(!b.checked()):b.currentPos>b.maxRange/2?b._setChecked(true):b._setChecked(false);b._animation(b.currentPos);c=false;h=d;return j=false}})},_animation:function(a){var b=this.element,c=this,d,e=c.checked();d=e?
true:false;var h=function(){a=d?a+10:a-10;a=Math.min(c.maxRange,a);a=Math.max(0,a);c._draw(a);if(d){if(a<c.maxRange){setTimeout(function(){h()},50);return}}else if(a>0){setTimeout(function(){h()},50);return}if(c.oldChecked!=e){var j=-1;c.$listitem&&(j=c.$listitem.find(".dvc-listitem-item-indexable").index(c.$item));b.trigger("ev_change",[c,e,j]);c.oldChecked=e}};setTimeout(function(){h()},50)},refresh:function(){var a=this.options;e.davinci.dvcBase.prototype.refresh.call(this);this.checked(a.checked);
var a=this.$onImage.outerWidth(true),b=this.$offImage.outerWidth(true);this.element.width(a+b)},_setChecked:function(a){this.options.checked=a},checked:function(a){var b=this.options;return a!=d?(this._setChecked(a),this._draw(b.checked==false?0:this.maxRange),this.oldChecked=a,this):b.checked},_initVars:function(){var a=this.options;this.handleLeftWidth=this.$handle.find("."+this.classes.CLS_SWITCH_HANDLE_LEFT).width();this.$text.css({left:this.handleLeftWidth,right:this.handleLeftWidth});var b=
this.$onText.outerWidth(true),c=this.$offText.outerWidth(true),a=Math.max(b,a.minWidth),a=Math.max(c,a);a+=this.handleLeftWidth;this.handleWidth=this.$handle.outerWidth(true);c=Math.round(this.handleWidth/2);a=Math.min(100-c,a);this.$onText.width(a);this.$offText.width(a);this.maxTextWidth=a;this.maxRange=this.maxTextWidth+this.handleLeftWidth},_draw:function(a){var b=this.maxRange,c=this.handleWidth,d=this.maxTextWidth,e=this.handleLeftWidth;Math.max(a,0);Math.min(a,b);var h=b-a,j=Math.round(c/2),
l=parseInt(j,10),e=parseInt(d+e+j,10)-l,b=parseInt(a*e/b,10);e-=b;this.$onImage.width(l+b);this.$offImage.width(l+e);this.$offText.css("left",c+d-h);this.$onText.css("left",-h);this.$handle.css("left",a)}})})(jQuery);
...
if(a!=d)this.options.enable=a,a==true?(this.element.removeClass("dvc-disabled"),b.removeAttr("disabled")):(this.element.addClass("dvc-disabled"),b.attr("disabled","disabled"));else return this.options.enable},text:function(a){var b=this.element.find("textarea");return arguments.length?(b.val(a),this):a=b.val()}})})(jQuery);
...
this.$input=g;b.text&&g.val(b.text);b.placeholder&&g.attr("placeholder",b.placeholder);a.append(g);a.append(e("<div class='"+c.CLS_TEXTFIELD_BTN_CLEAR+"'></div>"));if(b.clearButton&&(this.$btnClear=a=a.find("."+c.CLS_TEXTFIELD_BTN_CLEAR)))a.dvcButton(),a.hide();this.enable(b.enable);this.visible(b.visible)},_attachEvent:function(){var a=this.element,b=this,c=this.options,d=this.$btnClear,e=this.$input,h=e[0];b._oldValue=h.value;e.focus(function(j){e.val()&&c.clearButton&&(d.show(),e.css("right",30));
b._timer&&clearInterval(b._timer);b._timer=setInterval(function(){if(b._oldValue!=h.value)if(b._oldValue=h.value,document.createEvent){var a;window.KeyEvent?(a=document.createEvent("KeyEvents"),a.initKeyEvent("keyup",true,true,window,false,false,false,false,65,0)):(a=document.createEvent("UIEvents"),a.initUIEvent("keyup",true,true,window,1),a.keyCode=65);h.dispatchEvent(a)}else a=document.createEventObject(),a.keyCode=65,h.fireEvent("onkeyup",a)},100);var l=-1;b.$listitem&&(l=b.$listitem.find(".dvc-listitem-item-indexable").index(b.$item));
a.trigger("ev_focus",[b,l]);j.stopPropagation()});e.blur(function(h){c.clearButton&&(d.hide(),e.css("right",0));b._timer&&clearInterval(b._timer);b._timer=null;var l=-1;b.$listitem&&(l=b.$listitem.find(".dvc-listitem-item-indexable").index(b.$item));a.trigger("ev_blur",[b,l]);h.stopPropagation()});e.bind("keyup",function(h){e.val()?c.clearButton&&(d.show(),e.css("right",30)):c.clearButton&&(d.hide(),e.css("right",0));if(b.enable()==true){var l=-1;b.$listitem&&(l=b.$listitem.find(".dvc-listitem-item-indexable").index(b.$item));
a.trigger("ev_keyup",[b,b.text(),h.keyCode,l]);h.stopPropagation()}});e.bind("vclick",function(c){if(b.enable()==true){var d=-1;b.$listitem&&(d=b.$listitem.find(".dvc-listitem-item-indexable").index(b.$item));a.trigger("ev_click",[b,d]);c.stopPropagation()}});c.clearButton&&d.bind("ev_click",function(){e.val("");d.hide();e.css("right",0);return false})},focus:function(){this.element.find("input").focus();return this},text:function(a){var b=this.element.find("input");return arguments.length?(b.val(a),
...
(function(e){e.widget("davinci.dvcAudio",e.davinci.dvcBase,{options:{loop:false,controls:false,autoplay:false,src:"",initSelector:":jqmData(role='dvcAudio')"},classes:{CLS_WIDGET:"dvc-audio"},_initWidget:function(){this.element.addClass(this.classes.CLS_WIDGET)},_appendChildElements:function(){var d=this.element,a=this.options,b=e("<audio>").appendTo(d);b[0].id=d[0].id+"_audio";a.loop&&b.attr("loop","");a.controls&&b.attr("controls","");a.autoplay&&b.attr("autoplay","");d=a.src.split(";");for(a=0;a<
d.length;a++)e("<source src='"+d[a]+"' />").appendTo(b);this._audio=b[0]},audio:function(){return this._audio}})})(jQuery);
(function(e,d){e.widget("davinci.dvcVideo",e.davinci.dvcBase,{options:{loop:false,controls:true,autoplay:false,src:"",poster:"",initSelector:":jqmData(role='dvcVideo')"},classes:{CLS_WIDGET:"dvc-video"},_initWidget:function(){this.element.addClass(this.classes.CLS_WIDGET)},_appendChildElements:function(){var a=this.element,b=this.options,c=e("<video>").appendTo(a);c[0].id=a[0].id+"_video";b.poster&&c.attr("poster",b.poster);b.loop&&c.attr("loop","");b.controls&&c.attr("controls","");b.autoplay&&c.attr("autoplay",
"");this._video=c[0];this.src(b.src)},src:function(a){var b=this.options,c=e(this._video);if(a!=d){c.empty();a=b.src.split(";");for(b=0;b<a.length;b++)e("<source src='"+a[b]+"' />").appendTo(c)}else return b.src;return this},video:function(){return this._video},refresh:function(){e.davinci.dvcBase.prototype.refresh.call(this);var a=e(this._video),b=this.element.outerWidth(true),c=this.element.outerHeight(true);b&&a.attr("width",b);c&&a.attr("height",c)}})})(jQuery);
...
_attachEvent:function(){var d=this.element,a=this;d.bind({swipeleft:function(b){a.enable()&&a._getAncestorEnable()&&(d.trigger("ev_swipeleft",[a]),b.stopPropagation())},swiperight:function(b){a.enable()&&a._getAncestorEnable()&&(d.trigger("ev_swiperight",[a]),b.stopPropagation())}})},refresh:function(){e.davinci.dvcBase.prototype.refresh.call(this);var d=this.element;d.siblings().filter(":jqmData(role='dvcContent')").css("bottom",d.height()+"px")}})})(jQuery);
...
this._stopMScroll();var d=this._$clip,f=this._$view;this._viewHeight=f.height();this._viewWidth=f.width();this.sendVMoustdown=false;this._hTrackerShow=this.getScrollMax().x>0?true:false;if(this.options.delayedClickEnabled&&(this._$clickEle=e(a.target).closest(this.options.delayedClickSelector),this._$clickEle.length>0))if(this._$clickEle[0].nodeName!="INPUT"&&this._$clickEle[0].nodeName!="TEXTAREA"&&this._$clickEle[0].nodeName!="VIDEO"){var m=this,o=new e.Event("vmousedown");o.originalEvent=a.originalEvent;
o.pageX=b;o.pageY=c;this._$clickEle.hasClass("dvc-switch")||this._$clickEle.hasClass("dvc-slider")?this._$clickEle.trigger(o):this.timerID=setTimeout(function(a){m._$clickEle.trigger(a);m.timerID=0;m.sendVMoustdown=true},50,o)}else return;this._lastX=b;this._lastY=c;this._doSnapBackY=this._doSnapBackX=false;this._speedY=this._speedX=0;this._directionLock="";this._didDrag=false;if(this._hTracker&&this._hTrackerShow){var n=parseInt(d.css("width"),10),b=parseInt(f.css("width"),10);this._maxX=n-b;if(this._maxX>
0)this._maxX=0;if(this._$hScrollBar)this.$hsbt.css("width",n>=b?"100%":Math.floor(n/b*100)+"%"),this.$hsbt.width()<5&&this.$hsbt.width(5),this.hsbtWidth=this.$hsbt.parent().width()}if(this._vTracker&&this._vTrackerShow){var q=parseInt(d.css("height"),10),d=parseInt(f.css("height"),10);this._maxY=q-d;if(this._maxY>0)this._maxY=0;if(this._$vScrollBar)this.$vsbt.css("height",q>=d?"100%":Math.floor(q/d*100)+"%"),this.$vsbt.height()<5&&this.$vsbt.height(5),this.vsbtHeight=this.$vsbt.parent().height()}d=
this.options.direction;this._pagePos=this._pageSize=this._pageDelta=0;if(this.options.pagingEnabled&&(d==="x"||d==="y"))this._pageSize=d==="x"?n:q,this._initPagePos=d==="x"?this._sx:this._sy,this._pagePos=this._initPagePos-this._initPagePos%this._pageSize;this._lastMove=0;this._enableTracking();(this.options.eventType=="mouse"||this.options.delayedClickEnabled)&&a.preventDefault();a.stopPropagation()}},_propagateDragMove:function(a,b,c,d,f){this._hideScrollBars();this._disableTracking();a._handleDragStart(b,
c,d);a._directionLock=f;a._didDrag=this._didDrag},_handleDragMove:function(a,b,c){if(this.enable()!=false){this._lastMove=f();var d=this._$view,d=b-this._lastX,k=c-this._lastY,m=this.options.direction;if(this._didDrag==false&&this.options.delayedClickEnabled&&this._$clickEle.length>0&&(this._$clickEle.hasClass("dvc-switch")||this._$clickEle.hasClass("dvc-slider")))return d=new e.Event("vmousemove"),d.originalEvent=a.originalEvent,d.pageX=b,d.pageY=c,this._$clickEle.trigger(d),false;if(!this._directionLock){var o=
Math.abs(d),n=Math.abs(k),q=this.options.moveThreshold;if(o<q&&n<q)return false;var p=null;o<n&&o/n<0.5?p="y":o>n&&n/o<0.5&&(p="x");if(m&&p&&m!=p){var s=this._getAncestorByDirection(p);if(s)return this._propagateDragMove(s,a,b,c,p),false}this._directionLock=m?m:p?p:"none"}var q=this._sx,r=this._sy;if(this._directionLock!=="y"&&this._hTracker&&(o=this._sx,this._speedX=d,q=o+d,this._doSnapBackX=false,q>0||q<this._maxX)){if(this.options.directionLock&&this._directionLock==="x"&&(s=this._getAncestorByDirection("x")))return this._setScrollPosition(q>
0?0:this._maxX,r),this._propagateDragMove(s,a,b,c,p),false;q=o+d/2;this._doSnapBackX=true}if(this._directionLock!=="x"&&this._vTracker&&this._vTrackerShow&&(n=this._sy,this._speedY=k,r=n+k,this._doSnapBackY=false,r>-this.options.nextLoadingBarHeight||r<this._maxY)){if(this.options.directionLock&&this._directionLock==="y"&&(s=this._getAncestorByDirection("y")))return this._setScrollPosition(q,r>0?0:this._maxY),this._propagateDragMove(s,a,b,c,p),false;r=n+k/2;this._doSnapBackY=true}if(this.options.pagingEnabled&&
(m==="x"||m==="y"))this._doSnapBackX||this._doSnapBackY?this._pageDelta=0:(o=m==="x"?q:r,d=m==="x"?d:k,this._pagePos=d<0?this._initPagePos-this._pageSize:this._initPagePos,this._pagePos-=this._initPagePos%this._pageSize,k=this._pagePos,this._pageDelta=k>o&&d<0?this._pageSize:k<o&&d>0?-this._pageSize:0);if(this._didDrag==false){if(this.timerID)clearTimeout(this.timerID),this.timerID=0;d=new e.Event("vmousecancel");d.originalEvent=a.originalEvent;d.pageX=a.pageX;d.pageY=a.pageY;this._$clickEle.trigger(d);
...
setTimeout(this._timerCB,this._timerInterval);else{if(this._toggleRefresh)this._toggleRefresh=false,this.options.nextLoadingBarHeight=this.oldNextLoadingBarHeight,this.oldNextLoadingBarHeight=0,this._$clip.trigger("ev_change",[this,"refresh-release"]);if(this._toggleMore)this._toggleMore=false,this._$clip.trigger("ev_change",[this,"more-release"]);this._stopMScroll()}},scrollTo:function(a,b,c){this._stopMScroll();var d=this._getViewHeight(),k=this._getClipHeight();if(!c)return d-k-this.options.nextLoadingBarHeight>
0&&b<-(d-k-this.options.nextLoadingBarHeight)&&(b=-(d-k-this.options.nextLoadingBarHeight)),this._setScrollPosition(-a,-(this.options.nextLoadingBarHeight-b));d-k-this.options.nextLoadingBarHeight>0&&b>d-k-this.options.nextLoadingBarHeight&&(b=d-k-this.options.nextLoadingBarHeight);b+=this.options.nextLoadingBarHeight;var a=-a,b=-b,m=this,o=f(),n=e.easing.easeOutQuad,q=this._sx,p=this._sy,s=a-q,r=b-p,t=function(){var d=f()-o;d>=c?(m._timerID=0,m._setScrollPosition(a,b)):(d=n(d/c,d,0,1,c),m._setScrollPosition(q+
s*d,p+r*d),m._timerID=setTimeout(t,m._timerInterval))};this._timerID=setTimeout(t,this._timerInterval);return this},getScrollPosition:function(){return{x:parseInt(-this._sx,10),y:parseInt(-(this._sy+this.options.nextLoadingBarHeight),10)}},getScrollMax:function(){return{x:parseInt(this._getViewWidth()-this._getClipWidth(),10),y:parseInt(this._getViewHeight()-this._getClipHeight(),10)}},setScrollBodyWidth:function(a){this._$view.css("min-width",a);return this},refresh:function(){e.davinci.dvcBase.prototype.refresh.call(this);
this.optimizeInit();return this},_handleDragStop:function(b){if(this.enable()!=false){var c=this._lastMove,d=f(),c=c&&d-c<=this.options.moveIntervalThreshold,d=this._getViewHeight(),l=this._getClipHeight(),k=this.getScrollPosition().y;if(d-l-this.options.nextLoadingBarHeight>0){if(k<0||k>d-l-this.options.nextLoadingBarHeight)this._doSnapBackY=true}else if(k!=0)this._doSnapBackY=true;d=this._hTracker&&this._hTrackerShow&&this._speedX&&c?this._speedX:this._doSnapBackX?1:0;l=this._vTracker&&this._vTrackerShow&&
this._speedY&&c?this._speedY:this._doSnapBackY?1:0;c=this.options.direction;this.options.pagingEnabled&&(c==="x"||c==="y")&&!this._doSnapBackX&&!this._doSnapBackY?(d=this._sx,l=this._sy,c==="x"?d=-this._pagePos+this._pageDelta:l=-this._pagePos+this._pageDelta,this.scrollTo(d,l,this.options.snapbackDuration)):d||l?this._startMScroll(d,l):this._hideScrollBars();this._disableTracking();if(!this._didDrag&&this.options.delayedClickEnabled&&this._$clickEle.length){if(this.timerID)clearTimeout(this.timerID),
...
if(a==0||a==1){var d=this.speed*(1-e.easing[this.easing](c/b,c,0,1,b)),k=this.pos+d,m=a==0&&(k<this.minPos||k>this.maxPos);m&&(k=k<this.minPos?this.minPos:this.maxPos);this.pos=k;if(a==1){if(c>=b)this.state=2,this.fromPos=this.pos,this.toPos=k<this.minPos?this.minPos:this.maxPos,this.duration=this.options.snapbackDuration,this.startTime=f()}else if(a==0)if(m)this.state=1,this.speed=d/2,this.duration=this.options.overshootDuration,this.startTime=f();else if(c>=b)this.state=3}else if(a==2)c>=b?(this.pos=
...
d){var f=this.element.find("ul");if(a.constructor==String)e(a).appendTo(f),this._items=[],f.children().each(function(){c._items.push(this.innerHTML)});else if(a.constructor==Array){var g=[];this._items=a;for(var h=0;h<a.length;h++)g.push("<li>"+a[h]+"</li>");f.append(g.join(""))}else return console.log("error"),this;if(c.activate)this.refresh();else b.closest(".ui-page").one("ev_pageshow",function(){c.refresh()});return this}else return this._items},selectedItem:function(){return this._items[this._index]},
clear:function(){this.element.find("ul").children().remove();this.scrollTo(0,0);this.itemHeight=0;this._items=[];return this},getCount:function(){return!this._items?-1:this._items.length},_handleDragStop:function(a){var b=this._lastMove,c=(new Date).getTime(),b=b&&c-b<=this.options.moveIntervalThreshold,c=this._getViewHeight(),d=this._getClipHeight(),g=this.getScrollPosition().y;if(c-d-this.options.nextLoadingBarHeight>0){if(g<0||g>c-d-this.options.nextLoadingBarHeight)this._doSnapBackY=true}else if(g!=
0)this._doSnapBackY=true;c=this._hTracker&&this._speedX&&b?this._speedX:this._doSnapBackX?1:0;d=this._vTracker&&this._speedY&&b?this._speedY:this._doSnapBackY?1:0;b=this.options.direction;this.options.pagingEnabled&&(b==="x"||b==="y")&&!this._doSnapBackX&&!this._doSnapBackY?(c=this._sx,d=this._sy,b==="x"?c=-this._pagePos+this._pageDelta:d=-this._pagePos+this._pageDelta,this.scrollTo(c,d,this.options.snapbackDuration)):c||d?this._startMScroll(c,d):(d=this._sy,this._pixelCorrection(d,a));this._disableTracking();
if(!this._didDrag&&this.options.delayedClickEnabled&&this._$clickEle.length){if(this.timerID)clearTimeout(this.timerID),this.timerID=0;if(this.sendVMoustdown==true)b=new e.Event("vmouseup"),b.originalEvent=a.originalEvent,b.pageX=a.pageX,b.pageY=a.pageY,this._$clickEle.trigger(b),this.options.eventType=="touch"&&this._$clickEle.trigger("vclick")}this._$clip.trigger("ev_dragstop",[this,this.getScrollPosition()]);return false},_pixelCorrection:function(a,b){var c=this.options,f=this.element;if(this.itemHeight){var e=
this.itemHeight,a=-a,h=parseInt(a/e);a%e>e/2&&h++;a=h*e;if(this.getScrollPosition().y==a)if(b!=d){for(var j=f[0],l=0;j.offsetParent.nodeName!="BODY";)l+=j.offsetTop,j=j.offsetParent;/dvc-popup/.test(j.className)&&(l+=j.offsetTop);j=parseInt(this.$pickerFrameBase.css("border-top-width"),10);h+=Math.floor((this._lastY-l-j)/e)-1;l=this.getCount();h<0?h=0:h>l-1&&(h=l-1);this._index=h;this.scrollTo(0,h*e,c.snapbackDuration)}else this._index=h,this.scrollTo(0,a,c.overshootDuration);else this._index=h,this.scrollTo(0,
a,c.overshootDuration);f.trigger("ev_change",[this,h])}},getIndex:function(){return this._index},setIndex:function(a){if(this.itemHeight)return this.scrollTo(0,-(a*this.itemHeight),0),a=Math.max(a,0),this._index=a=Math.min(a,this._items.length),this}})})(jQuery);
...
e.easing.easeOutQuad,l=this._sx,k=this._sy,m=d-l,o=a-k,n=function(){var c=(new Date).getTime()-h;c>=b?(g._timerID=0,g._setScrollPosition(d,a),g.element.triggerHandler("ysScrollTo",{x:d,y:a})):(c=j(c/b,c,0,1,b),g._setScrollPosition(l+m*c,k+o*c),g._timerID=setTimeout(n,g._timerInterval))};this._timerID=setTimeout(n,this._timerInterval)}else c-f>0&&a<-(c-f)&&(a=-(c-f)),this._setScrollPosition(d,a),this.element.triggerHandler("ysScrollTo",{x:d,y:a})},_slideCallback:function(d){var a=this.element,b=this.options,
...
CLS_CAROUSEL_INDICATOR_X:"dvc-carousel-indicator-x",CLS_CAROUSEL_INDICATOR_Y:"dvc-carousel-indicator-y"},_create:function(){var d=this.element,a=this.options,b=this.classes;if(!a.theme)a.theme=e.davinci.getInheritedTheme(d);a.theme=e.davinci._changeThemeName(a.theme);b.CLS_THEME=b.CLS_WIDGET+"-"+a.theme;d.addClass(b.CLS_WIDGET+" "+b.CLS_THEME);this.totalPage=0;this.nowPage=1;this.refresh()},setCount:function(d){if(!(d<0))return this.totalPage=d,this.refresh(),this},setIndex:function(d){var a=this.element,
b=this.classes;if(!(this.totalpage<=0))return this.nowPage=d,a.find("."+b.CLS_CAROUSEL_INDICATOR_ON).removeClass(b.CLS_CAROUSEL_INDICATOR_ON),a.find("."+b.CLS_CAROUSEL_INDICATOR_ITEM).eq(d-1).addClass(b.CLS_CAROUSEL_INDICATOR_ON),this},clear:function(){this.setIndex(1);this.setCount(0);return this},refresh:function(){e.davinci.dvcBase.prototype.refresh.call(this);var d=this.element,a=this.options,b=this.classes;d.find("."+b.CLS_CAROUSEL_INDICATOR_ITEM).remove();if(!(this.totalPage<=0)){a.direction==
"x"?(d.addClass(b.CLS_CAROUSEL_INDICATOR_X).removeClass(b.CLS_CAROUSEL_INDICATOR_Y),d.height(a.size)):(d.addClass(b.CLS_CAROUSEL_INDICATOR_Y).removeClass(b.CLS_CAROUSEL_INDICATOR_X),d.width(a.size));for(var a=e("<div class='"+b.CLS_CAROUSEL_INDICATOR_ITEM+"'></div>"),c=0;c<this.totalPage;c++){var f=a.clone().appendTo(d);this.nowPage==c+1&&f.addClass(b.CLS_CAROUSEL_INDICATOR_ON)}return this}}})})(jQuery);
...
break;case "checkboxradio":a.addClass(b.CLS_LAYOUTVIEW_CHKRDO);break;default:a.addClass(b.CLS_LAYOUTVIEW_NONE).removeClass(b.CLS_LAYOUTVIEW_UP)}},_initWidget:function(){var a=this.element,b=this.options,c=this.classes;if(!b.theme)b.theme=e.davinci.getInheritedTheme(a);b.theme=e.davinci._changeThemeName(b.theme);c.CLS_THEME=c.CLS_WIDGET+"-"+b.theme;a.addClass(c.CLS_WIDGET+" "+c.CLS_LAYOUTVIEW_UP+" "+c.CLS_THEME);this._initType()},_appendChildElements:function(){var a=this.element,b=this.classes;switch(this.options.type){case "link":e("<div class='"+
...
c.CLS_THEME=c.CLS_WIDGET+"-"+b.theme;a.addClass(c.CLS_WIDGET+" "+c.CLS_THEME);this._items=[];this._initType();this._findScrollview()},_appendChildElements:function(){var a=this.element,b=this.options,c=this.classes,d=e("<div class='"+c.CLS_LISTITEM_ITEM_DESIGN+" "+c.CLS_LISTITEM_ITEM_INDEXABLE_DESIGN+" "+c.CLS_LISTITEM_ITEM_UP_DESIGN+"'></div>"),g=e("<div class='"+c.CLS_LISTITEM_ITEMS+"'></div>");this.$designItem=d;this.backgroundLayout(this.backgroundLayout());this.$items=g;a.find("[id]").not("[subid]").each(function(){this.outerHTML=
this.outerHTML.replace(/\sid/g," subid")});var h=a[0].innerHTML;a.children().remove();d.append(h);a.append(d);a.append(g);switch(b.type){case "link":e("<div class='"+c.CLS_LISTITEM_LINK_ICON+"'></div>").appendTo(this.$designItem);break;case "checkbox":case "checkboxradio":a=e("<div class='"+c.CLS_LISTITEM_CHK_ICON+"'></div>"),a.appendTo(this.$designItem),this.$checkbox=a}},backgroundLayout:function(a){var b=this.options,c=this.classes;if(arguments.length)switch(this.$designItem.removeClass(c.CLS_BASE_LAYOUT_TILE+
" "+c.CLS_BASE_LAYOUT_STRETCH+" "+c.CLS_BASE_LAYOUT_ZOOM+" "+c.CLS_BASE_LAYOUT_CENTER),b.backgroundLayout=a,a){case "tile":this.$designItem.addClass(c.CLS_BASE_LAYOUT_TILE);break;case "stretch":this.$designItem.addClass(c.CLS_BASE_LAYOUT_STRETCH);break;case "zoom":this.$designItem.addClass(c.CLS_BASE_LAYOUT_ZOOM);break;case "center":this.$designItem.addClass(c.CLS_BASE_LAYOUT_CENTER)}else return a=b.backgroundLayout},update:function(a,b){var c=this.element,f=this.classes;b==d&&(b=0);for(var g=0;g<
a.length;++g){var h=a[g],j=c.find("."+f.CLS_LISTITEM_ITEM_INDEXABLE).eq(b);if(j.length==0)return;this._items[b]=h;b++;j.find("div:jqmData(role^='dvc')").each(function(){var a=e(this).jqmData("role");if(a){var b=e(this),c=b.attr("subid"),b=b.data(a);h[c]&&(a=="dvcImage"?b.src(h[c]):a=="dvcLabel"||a=="dvcButton"||a=="dvcImageButton"||a=="dvcTextfield"?b.text(h[c]):a=="dvcRadioButton"||a=="dvcCheckbox"||a=="dvcSwitch"?b.checked(h[c]):a=="dvcProgress"||a=="dvcSlider"?b.value(h[c]):h.userClass?b.element.addClass(h.userClass):
h.userData&&b.element.data("userData",h.userData))}})}this.scrollview&&this.scrollview.refresh()},add:function(a,b){var c=this.element,f=this.classes,g=this.$designItem[0].outerHTML,g=g.replace(/-design/g,""),g=e(g),h;if(b!=d){var j,l;h=a.length;for(j=0,l=b;j<h;j++,l++)this._items.splice(l,0,a[j])}else this._items=this._items.concat(a);for(j=0;j<a.length;++j){var k=a[j];typeof k=="string"?(k=k.replace(/\sid/g," subid"),h=e(k)):(h=g.clone(),k.userClass&&h.addClass(k.userClass),k.userData&&h.data("userData",
k.userData));b!=d?(l=c.find("."+f.CLS_LISTITEM_ITEM_INDEXABLE).eq(b),l.length==0?this.$items.append(h):h.insertBefore(l),b++):this.$items.append(h);h.find("div:jqmData(role^='dvc')").each(function(){var a=e(this).jqmData("role");if(a){var b=e(this),c=b.attr("subid"),d={};if(k[c])if(a=="dvcImage")d.src=k[c];else if(a=="dvcLabel"||a=="dvcButton"||a=="dvcImageButton"||a=="dvcTextfield")d.text=k[c];else if(a=="dvcRadioButton"||a=="dvcCheckbox"||a=="dvcSwitch")d.checked=k[c];else if(a=="dvcProgress"||
a=="dvcSlider")d.value=k[c];if(b.data(a))return true;b[a](d)}})}this.scrollview&&this.scrollview.refresh();return this},remove:function(a){var b=this.element,c=this.classes;this._items.splice(a,1);b.find("."+c.CLS_LISTITEM_ITEM_INDEXABLE).eq(a).remove();this.scrollview&&(this.scrollview.scrollTo(0,0),this.scrollview.refresh());return this},clear:function(){var a=this.element,b=this.classes;this._items=[];a.find("."+b.CLS_LISTITEM_ITEMS).children().remove();this.scrollview&&(this.scrollview.scrollTo(0,
0),this.scrollview.refresh());return this},items:function(a){return arguments.length?(this.clear(),this.add(a),this):this._items},getCount:function(){return this.element.find("."+this.classes.CLS_LISTITEM_ITEM_INDEXABLE).length},_attachEvent:function(){var a=this.element,b=this,c=this.options,d=this.classes;a.find("."+d.CLS_LISTITEM_ITEM).live({swipeleft:function(g){if(c.type!="none"){var h=a.find("."+d.CLS_LISTITEM_ITEM_INDEXABLE).index(e(this));b.enable(h)&&(a.trigger("ev_swipeleft",[b,h]),g.stopPropagation())}},
swiperight:function(g){if(c.type!="none"){var h=a.find("."+d.CLS_LISTITEM_ITEM_INDEXABLE).index(e(this));b.enable(h)&&(a.trigger("ev_swiperight",[b,h]),g.stopPropagation())}},vmousedown:function(g){b._prevmousedown();if(c.type!="none"){var h=a.find("."+d.CLS_LISTITEM_ITEM_INDEXABLE).index(e(this));b.enable(h)==true&&(e(this).removeClass(d.CLS_LISTITEM_ITEM_UP).addClass(d.CLS_LISTITEM_ITEM_DOWN),g.stopPropagation());g.target.nodeName.toLowerCase()!="input"&&g.preventDefault()}},"vmouseup vmousecancel":function(g){if(!b._prevmouseup(g)&&
c.type!="none"){var h=a.find("."+d.CLS_LISTITEM_ITEM_INDEXABLE).index(e(this));b.enable(h)==true&&(e(this).removeClass(d.CLS_LISTITEM_ITEM_DOWN).addClass(d.CLS_LISTITEM_ITEM_UP),g.stopPropagation())}},vclick:function(g){if(!b._prevclick()&&c.type!="none"){var h=a.find("."+d.CLS_LISTITEM_ITEM_INDEXABLE).index(e(this));b.enable(h)&&b._getAncestorEnable()&&!b.scrollviewDragged()&&(c.type=="checkbox"?(b.toggle(h),a.trigger("ev_change",[b,b.checked(h),h])):c.type=="radio"||c.type=="checkboxradio"?(b.checked(h)==
false&&b.checked(h,true),a.trigger("ev_change",[b,true,h])):a.trigger("ev_click",[b,h]),g.stopPropagation())}}})},toggle:function(a){this.checked(a,!this.checked(a))},visible:function(a){var b=this.options;e.davinci.dvcBase.prototype.visible.call(this,a);if(a!=d)this.scrollview&&this.scrollview.refresh();else return b.visible},refresh:function(){this.enable(-1,this.enable(-1));this.visible(this.visible());return this},enable:function(a,b){var c=this.element,d=this.classes;if(arguments.length==2)a<
0?e.davinci.dvcBase.prototype.enable.call(this,b):(c=c.find("."+d.CLS_LISTITEM_ITEM_INDEXABLE).eq(a),b?c.removeClass(d.CLS_BASE_DISABLED):c.addClass(d.CLS_BASE_DISABLED));else return a<0?e.davinci.dvcBase.prototype.enable.call(this):(c=c.find("."+d.CLS_LISTITEM_ITEM_INDEXABLE).eq(a),!c.hasClass(d.CLS_BASE_DISABLED));return this},checked:function(a,b){var c=this.element,d=this.classes;if(arguments.length==2)return this.options.type=="checkboxradio"||this.options.type=="radio"?c.find("."+d.CLS_LISTITEM_ITEM_INDEXABLE).each(function(b){b==
a?e(this).addClass(d.CLS_BASE_CHECKED):e(this).removeClass(d.CLS_BASE_CHECKED)}):this.options.type=="checkbox"&&(c=c.find("."+d.CLS_LISTITEM_ITEM_INDEXABLE).eq(a),b?c.addClass(d.CLS_BASE_CHECKED):c.removeClass(d.CLS_BASE_CHECKED)),this;else{c=c.find("."+d.CLS_LISTITEM_ITEM_INDEXABLE).eq(a);if(c.length)switch(this.options.type){case "checkboxradio":case "radio":case "checkbox":return c.hasClass(d.CLS_BASE_CHECKED)}return false}},userData:function(a,b){var c=this.element.find("."+this.classes.CLS_LISTITEM_ITEM_INDEXABLE).eq(a);
return arguments.length==2?(c.data("userData",b),this):c.data("userData")}})})(jQuery);
(function(e){e.widget("davinci.dvcListview",e.davinci.dvcScrollview,{options:{type:"none",eventNames:"ev_click,ev_change,ev_keyup,ev_swipeleft,ev_swiperight,ev_focus,ev_blur,ev_scrollstart,ev_scrollupdate,ev_scrollstop,ev_dragstart,ev_dragmove,ev_dragstop".split(","),initSelector:":jqmData(role='dvcListview')"},classes:{CLS_WIDGET:"dvc-listview"},_appendChildElements:function(){var d=this.options,a=this.classes,b=this.element.children(),a=e("<div>").addClass(a.CLS_SCROLLVIEW_VIEW),c=e("<div>");a.append(c);
c.append(b);this._$clip.append(a);this._$view=a;c.dvcListitem({type:d.type});this._listitem=c.data("dvcListitem")},_create:function(){this._initWidget();this._appendChildElements();this._initVars();this._attachEvent();this.refresh()},getListitem:function(){return this._listitem}})})(jQuery);
...
setIconWidth:function(a){var b=this.options;b.iconWidth=a;this._drawTreeview(b.data);return this},_drawTreeview:function(a){var b=this.element,c=a.length,d=[0],g=[];this.options.data=a;this.removeAll();g.push("<ul class='dvc-treeview-node-container'>");for(var h=b.css("width"),j=0;j<c;j++){var l=false;d[0]=j;j+1==c&&(l=true);this._drawLi(parseInt(h.replace("px",""),10),a[j],g,0,""+d[0],l)}g.push("</ul>");a=e(g.join(""));b.prepend(a);return this},_drawLi:function(a,b,c,f,e,h){var j=this.options,l=
j.iconWidth,k="",m=false,o="dvc-treeview-nohaschild-icon",n="dvc-treeview-middle-line",q=0;h&&(k=n=" ");c.push("<li id='"+b.id+"' deep='"+f+"' path='"+e+"' class='"+k+"'>");c.push("<div class='dvc-treeview-node-background dvc-treeview-li-back-style'>");c.push("<span class='dvc-treeview-line-group'>");for(var k=e.indexOf(".")?this._isLastParent(e):[0],p=0;p<f;p++){var s="";k[p]&&(s="visibility:hidden;");c.push("<span class='dvc-treeview-line-icon dvc-treeview-basic-line' style='"+s+"'></span>");q++}h?
c.push("<span class='dvc-treeview-line-icon dvc-treeview-last-line' style=''></span>"):c.push("<span class='dvc-treeview-line-icon "+n+"' style=''></span>");q++;b.childnodes!=d||b.hasChildren?m=true:(c.push("<span class='dvc-treeview-line-icon dvc-treeview-horizontal-line'></span>"),q++);c.push("</span>");m&&(n="dvc-treeview-open-icon",o="dvc-treeview-haschild-icon",b.isexpand||(n="dvc-treeview-close-icon"),c.push("<span class='dvc-treeview-expend-icon "+n+"'></span>"),q++);e=="0"&&(o="dvc-treeview-root-icon");
if(j.treeType=="depticon"||j.treeType=="all")c.push("<span class='"+o+"'></span>"),q++;o=" ";b.selected&&(o=" dvc-treeview-selected-node");n="";n=j.treeType=="check"||j.treeType=="all"?"width:"+(a-l*q-25)+"px;":"width:"+(a-l*q-5)+"px;";n.indexOf("-")>=0&&(n="width:"+q+"px;");c.push("<span class='dvc-treeview-node-name-back "+o+"' style='"+n+"'><span class='dvc-treeview-node-name'>"+b.text+"</span></span>");(j.treeType=="check"||j.treeType=="all")&&c.push("<span class='dvc-treeview-ischeck-back'><span class='dvc-treeview-ischeck-icon dvc-treeview-check-up'></span></span>");
c.push("</div>");if(m&&b.childnodes!=d){j=b.childnodes.length;l=b.childnodes;m="";e=(""+e).split(".");h&&(m="background-image:none;");e.push(0);b.isexpand||(m+="display:none;");c.push("<ul style='"+m+"' >");f++;for(b=0;b<j;b++)h=false,e[e.length-1]=b,b==j-1&&(h=true),this._drawLi(a,l[b],c,f,e.join("."),h);c.push("</ul>")}c.push("</li>")},_isLastParent:function(a){for(var b=[],c=this.options.data,a=a.split("."),d=a.length,e=0;e<d;e++){var h=a[e],j=0;e==0?(j=c.length-1,c=c[h]):(j=c.childnodes.length-
...
b){for(var c=this.options.data,e=a.split("."),g=e.length,h=0;h<g;h++)if(h==g-1){var j=e[h];if(h==0)c.splice(j,1);else{var l=c.childnodes[j];c.childnodes.splice(j,1);if(b&&l.childnodes!=d)c.childnodes=this._atJoinArray(c.childnodes,l.childnodes,j);if(!c.childnodes.length)c.childnodes=null,c.isexpand=false}}else c=h==0?c[e[h]]:c.childnodes[e[h]]},_setItems:function(a,b,c){for(var d=this.options.data,a=a.attr("path").split("."),e=a.length,h=0;h<e;h++)if(h==e-1){var j=a[h];h==0?c=="after"?this.options.data=
...
d){var g=this.classes,h=new e.Deferred,j=b?" reverse":"",l="ui-mobile-viewport-transitioning viewport-"+a;c.animationComplete(function(){c.add(d).removeClass("out in reverse "+a);d&&d[0]!==c[0]&&d.removeClass(g.CLS_PAGEBOX_ACTIVEPAGE);c.parent().removeClass(l);h.resolve(a,b,c,d)});c.parent().addClass(l);d&&d.addClass(a+" out"+j);c.addClass(g.CLS_PAGEBOX_ACTIVEPAGE+" "+a+" in"+j);return h.promise()},_transitionPages:function(a,b,c,d){b&&b.data("page")._trigger("beforehide",null,{nextPage:a});a.data("page")._trigger("beforeshow",
...
"none";if(c.pageContainer.find(g).length==0){var g=d,l=h.closest("."+f.CLS_WIDGET).first();l&&(g=l.data("dvcPagebox"));j=h.hasClass(f.CLS_PAGEBOX_ACTIVEPAGE);c.pageContainer.prepend(h);if(g)if(l=l.find(":jqmData(role='page')"),l.length>0){if(j)j=l.first(),j.addClass(f.CLS_PAGEBOX_ACTIVEPAGE),g.$activePage=j}else g._createEmptyPage()}f=e.extend({},c.defaults,b);f.pageContainer=f.pageContainer||c.pageContainer;f.fromPage=f.fromPage||c.$activePage;(g=f.fromPage)&&g[0]===h[0]&&!f.allowSamePageTransition?
...
a=false;c.obj=a?a.addClass(d.CLS_POPUP_OVERLAY).prependTo("body"):false;var j,l=h.closest(".dvc-pagebox");l.length&&(j=l.data("dvcPagebox"));a=h.hasClass(c.activePageClass);c.pageContainer.append(h);if(j)if(l=l.find(":jqmData(role='page')"),l.length){if(a)a=l.first(),a.addClass(c.activePageClass),j.activePage=a}else j._createEmptyPage();c._enhancePage(h);c.activePage=h;if(g.onbeforeshow)g.onbeforeshow();e._fnFindActivePagesInPagebox(h).each(function(){e._fnSubpageEventGenerate(this,"ev_pagebeforeshow")});
var k=h.data("page");h._pageTrigger("ev_pagebeforeshow",[k]);h.addClass(d.CLS_PAGEBOX_ACTIVEPAGE);b.show();var m=function(){e._fnFindActivePagesInPagebox(h).each(function(){e._fnSubpageEventGenerate(this,"ev_pageshow")});h._pageTrigger("ev_pageshow",[k]);if(g.onshow)g.onshow()};c._isShown=true;g.transition!="none"?(b.animationComplete(function(){m()}),b.addClass(g.transition+" in")):m()}}},close:function(){var a=this.element,b=this,c=this.options,d=this.classes;if(b._isShown!=false){if(c.onbeforehide)c.onbeforehide();
...
{};b[this._widgetId]=this.jsonObject;try{ko.applyBindings(b,this.element[0].parentNode)}catch(c){this._error({code:1001,name:"DataBindingError",message:"Knockout.js applybindings run error."});return}}a.trigger("ev_complete",this);return this},_create:function(){var a=this,b=this.options,c=this.classes,d;for(d in b)(function(){var c=d;a[c]=function(d){return arguments.length===0?b[c]:(b[c]=d,a)}})();a._widgetId=a.element[0].id;b.bindonload&&setTimeout(function(){a.load()},1);a.element.addClass(c.CLS_WIDGET)},
_success:function(a){var b=this.options,c=this.element;if(b.sourcetype==="xml")try{a=e.xml2json(a)}catch(f){this._error({code:1002,name:"XmlParsingError",message:"Xml2JSON Parsing Error."});return}if(a==null||a==="")this._error({code:1003,name:"NullData",message:"Received Data is empty."});else if(this.data(a),this._loadingShowAndHide(false),a=c.triggerHandler("ev_load",this),a===d||a)this.data(this.jsonObject),b.autouibind&&((b=c.triggerHandler("ev_apply",this))||b===d)&&this.apply()},_error:function(a){this.element.trigger("ev_error",
{datasource:this,error:a});this._loadingShowAndHide(false)},load:function(){this._run();return this},store:function(){var a=this.options;this._loadingShowAndHide(true);this._isStorage()?this._storage():this.data(a.value);this._loadingShowAndHide(false);return this},_run:function(){var a=this.options;a.schedule===0&&this._runSchedule!==d?(clearInterval(this._runSchedule),this._runSchedule=d):(this._loadingShowAndHide(true),this._isStorage()&&a.key!==d?(this._storage(),a.schedule&&this._runSchedule===
d&&this._startSchedule()):this._isAjax()&&a.url!==d&&a.sourcetype!==d?(this._request(),a.schedule&&this._runSchedule===d&&this._startSchedule()):this._error({code:1E3,name:"DataSourceOptionError",message:"DataSource properties is not defined."}))},_request:function(){var a=this.options,b=this;a.url!==d&&(e.ajaxSetup({error:function(a,d){b._error({code:a.status,name:"HTTPError",message:d==="parsererror"?"Requested JSON parse failed.":d==="timeout"?"Time out error.":d==="abort"?"Ajax request aborted.":
a.status===0?"Not connect. Verify Network.":a.status==404?"Requested page not found. [404]":a.status==500?"Internal Server Error [500].":"Uncaught Error. "+a.responseText})}}),e.ajax({async:false,type:a.method||"GET",url:a.url,data:a.query||{},dataType:a.proxy==="jsonp"?"jsonp":a.sourcetype,timeout:a.timeout,success:function(a){b._success(a)}}))},_storage:function(){var a=this.options,b=this.element;if(this._setStorage())try{a.action==="load"?this._success(this.webStorage[a.key]):a.action==="store"&&
(a.key===d||a.value===d?this._error({code:1006,name:"StoreError",message:"Key value undefined or Data value undefined."}):(this.webStorage.setItem(a.key,JSON.stringify(a.value)),this.data(JSON.parse(this.webStorage[a.key])),b.trigger("ev_store",this)))}catch(c){this._error({code:1007,name:"WebStorageException",message:c.name+" , "+c.message})}else this._error({code:1005,name:"StorageNotSupport",message:a.proxy+" is not support."})},_setStorage:function(){var a=this.options;if("localStorage"in window&&
window.localStorage!==null&&"sessionStorage"in window&&window.sessionStorage!==null){if(a.proxy==="localStorage")this.webStorage=window.localStorage;else if(a.proxy==="sessionStorage")this.webStorage=window.sessionStorage;return true}else return false},_loadingShowAndHide:function(a){this.options.showloadingmsg&&(a?e.davinci.showPageLoadingMsg(null,"Loading..."):e.davinci.hidePageLoadingMsg())},_startSchedule:function(){var a=this;a._runSchedule=setInterval(function(){a._run()},this.options.schedule)},
_isStorage:function(){return this.options.proxy==="localStorage"||this.options.proxy==="sessionStorage"},_isAjax:function(){return this.options.proxy==="ajax"||this.options.proxy==="jsonp"}})})(jQuery);
(function(e,d){var a=new function(){var a=[],c=function(c,d){a.push(arguments);if(!a.timer)a.timer=setTimeout(f,10)},f=function(){if(typeof ko!=="undefined"&&ko.bindingHandlers){a.timer=d;c=function(a,b){var c,d,f=function(a){var b=Array.prototype.slice.call(arguments),f=b.pop();if(a){var g;g=a;var h=null,k=e(g).jqmData("role");k&&(h=e(g).data(k));(g=h)&&f in c?(b[0]=g,c[f].apply(null,b)):d&&f in d&&d[f].apply(null,b)}else console.error("element is undefined or null")};ko.bindingHandlers[a]=new function(a,
